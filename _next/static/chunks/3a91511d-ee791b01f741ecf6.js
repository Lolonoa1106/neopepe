  ...
  [8956],
  {
    23570: (e, t, r) => {
      ...
      let L = (e = "publicKey") => g.av(32, e),
        z = (e = "signature") => g.av(64, e),
        q = (e = "string") => {
          let t = g.w3(
              [
                g.DH("length"),
                g.DH("lengthPadding"),
                g.av(g.cY(g.DH(), -8), "chars"),
              ],
              e
            ),
            r = t.decode.bind(t),
          ...
          return (
            ...
            (t.alloc = (e) =>
              g.DH().span + g.DH().span + n.Buffer.from(e, "utf8").length),
            t
          );
        };
      function Y(e) {
      ...
      class j {
        ...
        getMessageComponents() {
          ...
          K(e.length <= 256, "Max static account keys length exceeded");
          ...
          {
            K(t.length > 0, "Expected at least one writable signer key");
            let [e] = t[0];
            K(
        ...
        drainKeysFoundInLookupTable(e, t) {
          ...
          for (let [s, n] of this.keyMetaMap.entries())
            if (t(n)) {
              ...
              n >= 0 &&
                (K(n < 256, "Max lookup table index exceeded"),
                r.push(n),
                i.push(t),
      ...
      class $ {
        ...
        static deserialize(e) {
          let t = [...e],
            r = D(t),
            i = 127 & r;
          K(r !== i, "Expected versioned message but received legacy message"),
            K(
              0 === i,
          ...
          let s = {
            ...
            n = [],
            a = Y(t);
          for (let e = 0; e < a; e++) n.push(new N(M(t, 0, 32)));
          let o = l().encode(M(t, 0, 32)),
            c = Y(t),
            u = [];
          for (let e = 0; e < c; e++) {
            let e = D(t),
      ...
      class X {
          ...
          return (
            e.forEach((e) => {
              "instructions" in e
                ...
                : this.instructions.push(new G(e));
            }),
            this
          );
        }
        compileMessage() {
          ...
          return (
            p.forEach((e) => {
              K(e.programIdIndex >= 0), e.accounts.forEach((e) => K(e >= 0));
            }),
            new U({
              header: {
...
Missing signature for public key${
        ...
        _serialize(e) {
          ...
          return (
            ...
            t.forEach(({ signature: e }, t) => {
              null !== e &&
                (K(64 === e.length, "signature has invalid length"),
                n.Buffer.from(e).copy(s, r.length + 64 * t));
            }),
            e.copy(s, r.length + 64 * t.length),
            K(s.length <= 1232, `Transaction too large: ${s.length} > 1232`),
            s
          );
        }
        get keys() {
          return (
            K(1 === this.instructions.length),
            this.instructions[0].keys.map((e) => e.pubkey)
          );
        }
        get programId() {
          return (
            K(1 === this.instructions.length), this.instructions[0].programId
          );
        }
        get data() {
          return K(1 === this.instructions.length), this.instructions[0].data;
        }
        static from(e) {
          let t = [...e],
            r = Y(t),
        ...
        static populate(e, t = []) {
          ...
          return (
            ...
            t.forEach((t, i) => {
              let s = {
                signature: t == l().encode(J) ? null : l().decode(t),
      ...
      class Z {
        ...
        serialize() {
          ...
          let r = g.w3([
              ...
              g.O6(z(), this.signatures.length, "signatures"),
        ...
        static deserialize(e) {
          ...
          return new Z(F.deserialize(new Uint8Array(t)), r);
        }
        sign(e) {
        ...
        addSignature(e, t) {
          K(64 === t.byteLength, "Signature must be 64 bytes long");
      ...
      let Q = new N("SysvarC1ock11111111111111111111111111111111");
      new N("SysvarEpochSchedu1e111111111111111111111111"),
        new N("Sysvar1nstructions1111111111111111111111111");
      let ee = new N("SysvarRecentB1ockHashes11111111111111111111"),
      ...
      let er = new N("SysvarStakeHistory1111111111111111111111111");
...
` +
      ...
      let ec = g.I0("lamportsPerSignature"),
        eu = g.w3([
          g.DH("version"),
          g.DH("state"),
          L("authorizedPubkey"),
          L("nonce"),
          g.w3([ec], "feeCalculator"),
        ]),
        el = eu.span;
      class ed {
        constructor(e) {
      ...
      let eg = Object.freeze({
        ...
        Transfer: {
          index: 2,
          layout: g.w3([g.DH("instruction"), eh("lamports")]),
        },
        CreateWithSeed: {
          index: 3,
          layout: g.w3([
      ...
      class ep {
        ...
        static transfer(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = eo(eg.Transfer, { lamports: BigInt(e.lamports) })),
                (r = [
                  { pubkey: e.fromPubkey, isSigner: !0, isWritable: !0 },
                  { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
                ])),
            new G({ keys: r, programId: this.programId, data: t })
          );
        }
        static assign(e) {
          let t, r;
          return (
            "basePubkey" in e
              ...
              : ((t = eo(eg.Assign, { programId: W(e.programId.toBuffer()) })),
                (r = [
        ...
        static nonceInitialize(e) {
          let t = eo(eg.InitializeNonceAccount, {
        ...
        static nonceAdvance(e) {
          let t = eo(eg.AdvanceNonceAccount);
          return new G({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: ee, isSigner: !1, isWritable: !1 },
        ...
        static nonceWithdraw(e) {
          let t = eo(eg.WithdrawNonceAccount, { lamports: e.lamports });
          return new G({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
        ...
        static nonceAuthorize(e) {
          let t = eo(eg.AuthorizeNonceAccount, {
        ...
        static allocate(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = eo(eg.Allocate, { space: e.space })),
                (r = [
                  { pubkey: e.accountPubkey, isSigner: !0, isWritable: !0 },
                ])),
            new G({ keys: r, programId: this.programId, data: t })
      ...
      ep.programId = new N("11111111111111111111111111111111");
      class em {
        constructor() {}
        static getMinNumSignatures(e) {
          return 2 * (Math.ceil(e / em.chunkSize) + 1 + 1);
        }
        static async load(e, t, r, i, s) {
          {
            ...
            if (null !== a) {
              ...
              a.data.length !== s.length &&
                (o = o || new X()).add(
                  ep.allocate({ accountPubkey: r.publicKey, space: s.length })
                ),
                a.owner.equals(i) ||
                  (o = o || new X()).add(
                    ep.assign({ accountPubkey: r.publicKey, programId: i })
                  ),
                a.lamports < n &&
                  (o = o || new X()).add(
                    ep.transfer({
            ...
            null !== o && (await en(e, o, [t, r], { commitment: "confirmed" }));
          }
          let a = g.w3([
              g.DH("instruction"),
              g.DH("offset"),
          ...
          for (; u.length > 0; ) {
            ...
            l.push(en(e, h, [t, r], { commitment: "confirmed" })),
      ...
      var ew = globalThis.fetch;
      class ek extends y.vE {
        constructor(e, t, r) {
          super(
            (e) => {
              let r = (0, y.kb)(e, {
      ...
      class eS {
        ...
        static deserialize(e) {
          let t = (function (e, t) {
            ...
            r = e.length - 56;
          K(r >= 0, "lookup table is invalid"),
            K(r % 32 == 0, "lookup table is invalid");
          let { addresses: i } = g
            .w3([g.O6(L(), r / 32, "addresses")])
            .decode(e.slice(56));
          return {
      ...
      let eI = {
        ...
        ev = /^[^:]+:\/\/([^:[]+|\[[^\]]+\])(:\d+)?(.*)/i,
        e_ = (0, m.au)((0, m.KJ)(N), (0, m.Yj)(), (e) => new N(e)),
        eA = (0, m.PV)([(0, m.Yj)(), (0, m.eu)("base64")]),
        eW = (0, m.au)((0, m.KJ)(n.Buffer), eA, (e) =>
      ...
      let eN = eP((0, m.L5)());
      function eE(e) {
        return (0, m.au)(eP(e), eN, (t) =>
          "error" in t ? t : { ...t, result: (0, m.vt)(t.result, e) }
        );
      }
      function eC(e) {
        return eE(
          (0, m.NW)({ context: (0, m.NW)({ slot: (0, m.ai)() }), value: e })
        );
      }
      function eT(e) {
        return (0, m.NW)({
          context: (0, m.NW)({ slot: (0, m.ai)() }),
          value: e,
        });
      }
      function eO(e, t) {
      ...
      let eL = (0, m.NW)({
        ...
        eq = (0, m.YO)(
          (0, m.NW)({ slot: (0, m.ai)(), prioritizationFee: (0, m.ai)() })
        ),
        eY = (0, m.NW)({
          total: (0, m.ai)(),
          validator: (0, m.ai)(),
        ...
        ej = (0, m.g1)((0, m.Yj)(), (0, m.YO)((0, m.ai)())),
        eH = (0, m.me)((0, m.KC)([(0, m.NW)({}), (0, m.Yj)()])),
        eD = (0, m.NW)({ err: eH }),
        eM = (0, m.eu)("receivedSignature"),
        eU = (0, m.NW)({
          "solana-core": (0, m.Yj)(),
            ...
            innerInstructions: (0, m.lq)(
              (0, m.me)(
                (0, m.YO)(
                  (0, m.NW)({
                    index: (0, m.ai)(),
                    instructions: (0, m.YO)((0, m.KC)([e$, eF])),
                  })
                )
              )
            ),
        ...
        e3 = eC(
          (0, m.NW)({
            ...
            nonCirculatingAccounts: (0, m.YO)(e_),
          })
        ),
        e2 = (0, m.NW)({
          amount: (0, m.Yj)(),
        ...
        e9 = eC((0, m.YO)((0, m.NW)({ lamports: (0, m.ai)(), address: e_ }))),
        te = (0, m.NW)({
          executable: (0, m.zM)(),
          owner: e_,
          lamports: (0, m.ai)(),
        ...
        tt = (0, m.NW)({ pubkey: e_, account: te }),
        tr = (0, m.au)(
          (0, m.KC)([(0, m.KJ)(n.Buffer), e4]),
          (0, m.KC)([eA, e4]),
          (e) => (Array.isArray(e) ? (0, m.vt)(e, eW) : e)
        ),
        ti = (0, m.NW)({
          executable: (0, m.zM)(),
          owner: e_,
        ...
        ts = (0, m.NW)({ pubkey: e_, account: ti }),
        tn = (0, m.NW)({
          state: (0, m.KC)([
            (0, m.eu)("active"),
            (0, m.eu)("inactive"),
        ...
        tc = (0, m.NW)({ subscription: (0, m.ai)(), result: eT(te) }),
        tu = (0, m.NW)({ pubkey: e_, account: te }),
        tl = (0, m.NW)({ subscription: (0, m.ai)(), result: eT(tu) }),
        td = (0, m.NW)({
          parent: (0, m.ai)(),
          slot: (0, m.ai)(),
          root: (0, m.ai)(),
        }),
        th = (0, m.NW)({ subscription: (0, m.ai)(), result: td }),
        tg = (0, m.KC)([
          (0, m.NW)({
            type: (0, m.KC)([
        ...
        tp = (0, m.NW)({ subscription: (0, m.ai)(), result: tg }),
        tm = (0, m.NW)({
          subscription: (0, m.ai)(),
          result: eT((0, m.KC)([eD, eM])),
        }),
        tf = (0, m.NW)({ subscription: (0, m.ai)(), result: (0, m.ai)() }),
        tb = (0, m.NW)({
          pubkey: (0, m.Yj)(),
        ...
        tw = eE(
          (0, m.NW)({ current: (0, m.YO)(ty), delinquent: (0, m.YO)(ty) })
        ),
        tk = (0, m.KC)([
          (0, m.eu)("processed"),
          (0, m.eu)("confirmed"),
        ...
        tS = (0, m.NW)({
          ...
          err: eH,
          confirmationStatus: (0, m.lq)(tk),
        }),
        tI = eC((0, m.YO)((0, m.me)(tS))),
        tv = eE((0, m.ai)()),
        t_ = (0, m.NW)({
          accountKey: e_,
        ...
        tA = (0, m.NW)({
          ...
          message: (0, m.NW)({
            ...
            addressTableLookups: (0, m.lq)((0, m.YO)(t_)),
          }),
        }),
        tW = (0, m.NW)({
          pubkey: e_,
          ...
          writable: (0, m.zM)(),
          source: (0, m.lq)(
            (0, m.KC)([(0, m.eu)("transaction"), (0, m.eu)("lookupTable")])
          ),
        }),
        tB = (0, m.NW)({
        ...
        tC = (0, m.au)(tN, tE, (e) =>
          "accounts" in e ? (0, m.vt)(e, tP) : (0, m.vt)(e, tx)
        ),
        tT = (0, m.NW)({
          signatures: (0, m.YO)((0, m.Yj)()),
          message: (0, m.NW)({
            accountKeys: (0, m.YO)(tW),
            instructions: (0, m.YO)(tC),
            recentBlockhash: (0, m.Yj)(),
            addressTableLookups: (0, m.lq)((0, m.me)((0, m.YO)(t_))),
          }),
        }),
        tO = (0, m.NW)({
          accountIndex: (0, m.ai)(),
        ...
        tL = (0, m.NW)({ writable: (0, m.YO)(e_), readonly: (0, m.YO)(e_) }),
        tz = (0, m.NW)({
          err: eH,
          fee: (0, m.ai)(),
          innerInstructions: (0, m.lq)(
          ...
          preTokenBalances: (0, m.lq)((0, m.me)((0, m.YO)(tO))),
          postTokenBalances: (0, m.lq)((0, m.me)((0, m.YO)(tO))),
          loadedAddresses: (0, m.lq)(tL),
        ...
        tq = (0, m.NW)({
          ...
          innerInstructions: (0, m.lq)(
            (0, m.me)(
              (0, m.YO)(
                (0, m.NW)({ index: (0, m.ai)(), instructions: (0, m.YO)(tC) })
              )
            )
          ),
          preBalances: (0, m.YO)((0, m.ai)()),
        ...
        t$ = eE(
          (0, m.me)(
            (0, m.NW)({
              ...
              parentSlot: (0, m.ai)(),
              transactions: (0, m.YO)(
                (0, m.NW)({ transaction: tA, meta: (0, m.me)(tz) })
              ),
              rewards: (0, m.lq)((0, m.YO)(tR)),
              blockTime: (0, m.me)((0, m.ai)()),
            })
        ...
        t0 = eC(
          (0, m.me)(
            (0, m.NW)({
              feeCalculator: (0, m.NW)({ lamportsPerSignature: (0, m.ai)() }),
            })
          )
        ),
        t1 = eE((0, m.Yj)()),
        ...
        t2 = (0, m.NW)({ result: eT(t3), subscription: (0, m.ai)() }),
        t5 = { "solana-client": "js/1.0.0-maintenance" };
      class t6 {
        constructor(e, t) {
          var r;
          let i, s, n, a, o, c;
          (this._commitment = void 0),
            ...
            (this.getBlockHeight = (() => {
              let e = {};
              return async (t) => {
                let { commitment: r, config: i } = eB(t),
        ...
        async getTokenAccountsByOwner(e, t, r) {
          let { commitment: i, config: s } = eB(r),
            n = [e.toBase58()];
          "mint" in t
        ...
        async getMultipleParsedAccounts(e, t) {
          let { commitment: r, config: i } = eB(t),
            ...
            o = (0, m.vt)(a, eC((0, m.YO)((0, m.me)(ti))));
          if ("error" in o)
            throw new es(o.error, `failed to get info for accounts ${s}`);
          return o.result;
        }
        async getMultipleAccountsInfoAndContext(e, t) {
          let { commitment: r, config: i } = eB(t),
            ...
            a = await this._rpcRequest("getMultipleAccounts", n),
            o = (0, m.vt)(a, eC((0, m.YO)((0, m.me)(te))));
          if ("error" in o)
            throw new es(o.error, `failed to get info for accounts ${s}`);
          return o.result;
        }
        ...
        async getStakeActivation(e, t, r) {
          let { commitment: i, config: s } = eB(t),
        ...
        async getProgramAccounts(e, t) {
          let { commitment: r, config: i } = eB(t),
            ...
            c = (0, m.YO)(tt),
            u =
              !0 === n.withContext ? (0, m.vt)(o, eC(c)) : (0, m.vt)(o, eE(c));
          if ("error" in u)
            throw new es(
              u.error,
        ...
        async confirmTransaction(e, t) {
          ...
          return (K(64 === i.length, "signature has invalid length"),
          "string" == typeof e)
              ...
              (async () => {
                if (((n = await c()), !o))
                  for (;;) {
                    ...
                    if ((await ea(2e3), o || ((n = await c()), o))) return;
                  }
              })();
            }),
        ...
        async getSlot(e) {
          let { commitment: t, config: r } = eB(e),
        ...
        async getSignatureStatus(e, t) {
          ...
          return K(1 === i.length), { context: r, value: i[0] };
        }
        ...
        async getTransaction(e, t) {
          ...
          return o
            ? {
                ...
                transaction: {
                  ...o.transaction,
                  message: eO(o.version, o.transaction.message),
                },
              }
            : o;
        }
        ...
        async getConfirmedTransaction(e, t) {
          ...
          return { ...n, transaction: X.populate(a, o) };
        }
        ...
        async getAddressLookupTable(e, t) {
          ...
          return (
            null !== i &&
              (s = new eS({ key: e, state: eS.deserialize(i.data) })),
            { context: r, value: s }
          );
        }
        async getNonceAndContext(e, t) {
          let { context: r, value: i } = await this.getAccountInfoAndContext(
            ...
            s = null;
          return (
            null !== i && (s = ed.fromAccountData(i.data)),
            { context: r, value: s }
          );
        }
        async getNonce(e, t) {
        ...
        _wsOnAccountNotification(e) {
          let { result: t, subscription: r } = (0, m.vt)(e, tc);
        ...
        onProgramAccountChange(e, t, r, i) {
          let { commitment: s, config: n } = eB(r),
            a = this._buildArgs(
              [e.toBase58()],
        ...
        _wsOnLogsNotification(e) {
          let { result: t, subscription: r } = (0, m.vt)(e, t2);
          this._handleServerNotification(r, [t.value, t.context]);
        }
        _wsOnSlotNotification(e) {
          let { result: t, subscription: r } = (0, m.vt)(e, th);
        ...
        _wsOnRootNotification(e) {
          let { result: t, subscription: r } = (0, m.vt)(e, tf);
          this._handleServerNotification(r, [t]);
        }
        onRootChange(e) {
          return this._makeSubscription(
      ...
      class t4 {
        ...
        static fromSecretKey(e, t) {
          ...
          return new t4({ publicKey: r, secretKey: e });
        }
        static fromSeed(e) {
          let t = I(e),
            r = new Uint8Array(64);
          return r.set(e), r.set(t, 32), new t4({ publicKey: t, secretKey: r });
        }
        get publicKey() {
        ...
        static createLookupTable(e) {
          let [t, r] = N.findProgramAddressSync(
            ...
            s = [
              ...
              { pubkey: ep.programId, isSigner: !1, isWritable: !1 },
            ];
          return [new G({ programId: this.programId, keys: s, data: i }), t];
        }
        static freezeLookupTable(e) {
          let t = eo(t7.FreezeLookupTable),
            r = [
              { pubkey: e.lookupTable, isSigner: !1, isWritable: !0 },
              { pubkey: e.authority, isSigner: !0, isWritable: !1 },
            ];
          return new G({ programId: this.programId, keys: r, data: t });
        }
        static extendLookupTable(e) {
          let t = eo(t7.ExtendLookupTable, {
          ...
          return (
            ...
            new G({ programId: this.programId, keys: r, data: t })
          );
        }
        static deactivateLookupTable(e) {
          let t = eo(t7.DeactivateLookupTable),
            r = [
              { pubkey: e.lookupTable, isSigner: !1, isWritable: !0 },
              { pubkey: e.authority, isSigner: !0, isWritable: !1 },
            ];
      ...
      t9.programId = new N("AddressLookupTab1e1111111111111111111111111");
      let re = Object.freeze({
        ...
        SetComputeUnitPrice: {
          index: 3,
          layout: g.w3([g.u8("instruction"), eh("microLamports")]),
        },
      });
      class rt {
        constructor() {}
        static requestUnits(e) {
          let t = eo(re.RequestUnits, e);
          return new G({ keys: [], programId: this.programId, data: t });
        }
        static requestHeapFrame(e) {
          let t = eo(re.RequestHeapFrame, e);
          return new G({ keys: [], programId: this.programId, data: t });
        }
        static setComputeUnitLimit(e) {
          let t = eo(re.SetComputeUnitLimit, e);
          return new G({ keys: [], programId: this.programId, data: t });
        }
        static setComputeUnitPrice(e) {
          let t = eo(re.SetComputeUnitPrice, {
            microLamports: BigInt(e.microLamports),
          });
          return new G({ keys: [], programId: this.programId, data: t });
        }
      }
      rt.programId = new N("ComputeBudget111111111111111111111111111111");
      let rr = g.w3([
        g.u8("numSignatures"),
        g.u8("padding"),
      ...
      class ri {
        ...
        static createInstructionWithPublicKey(e) {
          ...
          return (
            ...
            u.fill(i, o),
            u.fill(r, c),
            new G({ keys: [], programId: ri.programId, data: u })
          );
        }
      ...
      ri.programId = new N("Ed25519SigVerify111111111111111111111111111");
      let rs = (e, t) => {
        let r = k.secp256k1.sign(e, t);
        return [r.toCompactRawBytes(), r.recovery];
      };
      k.secp256k1.utils.isValidPrivateKey;
      let rn = k.secp256k1.getPublicKey,
        ra = g.w3([
          g.u8("numSignatures"),
          g.NX("signatureOffset"),
      ...
      class ro {
        ...
        static createInstructionWithEthAddress(e) {
          ...
          let c = 12 + t.length,
            u = c + s.length + 1,
            l = n.Buffer.alloc(ra.span + i.length);
          return (
            ra.encode(
              {
                numSignatures: 1,
            ...
            l.fill(W(i), ra.span),
            new G({ keys: [], programId: ro.programId, data: l })
          );
        }
        static createInstructionWithPrivateKey(e) {
          let { privateKey: t, message: r, instructionIndex: i } = e;
      ...
      ro.programId = new N("KeccakSecp256k11111111111111111111111111111");
      let rc = new N("StakeConfig11111111111111111111111111111111");
      class ru {
        constructor(e, t, r) {
      ...
      ru.default = new ru(0, 0, N.default);
      let rl = Object.freeze({
        Initialize: {
          ...
          layout: g.w3([
            ...
            ((e = "lockup") =>
              g.w3(
                [g.Wg("unixTimestamp"), g.Wg("epoch"), L("custodian")],
                e
              ))(),
          ]),
        },
      ...
      class rd {
        ...
        static authorize(e) {
          let {
            ...
            o = [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: Q, isSigner: !1, isWritable: !0 },
              { pubkey: r, isSigner: !0, isWritable: !1 },
            ];
          return (
            n && o.push({ pubkey: n, isSigner: !0, isWritable: !1 }),
            new X().add({ keys: o, programId: this.programId, data: a })
          );
        }
        static authorizeWithSeed(e) {
          ...
          return (
            ...
            new X().add({ keys: u, programId: this.programId, data: c })
          );
        }
      ...
      (rd.programId = new N("Stake11111111111111111111111111111111111111")),
        (rd.space = 200);
      ...
      class rg {
        ...
        static updateValidatorIdentity(e) {
          let {
            ...
            s = eo(rh.UpdateValidatorIdentity);
          return new X().add({
            keys: [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: i, isSigner: !0, isWritable: !1 },
      ...
      (rg.programId = new N("Vote111111111111111111111111111111111111111")),
        (rg.space = 3762),
        ...
        g.w3([
          ...
          g.I0(),
          g.O6(
            g.w3([g.I0("slot"), g.DH("confirmationCount")]),
            g.cY(g.DH(), -8),
            "votes"
          ),
          g.u8("rootSlotValid"),
          ...
          g.I0(),
          g.O6(
            g.w3([g.I0("epoch"), L("authorizedVoter")]),
            g.cY(g.DH(), -8),
            "authorizedVoters"
          ),
          g.w3(
