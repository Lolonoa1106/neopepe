...
`;
      ...
      let m = {
        ...
        bin: async () => (await i.e(1144).then(i.bind(i, 51144))).binSvg,
        bitcoin: async () => (await i.e(223).then(i.bind(i, 20223))).bitcoinSvg,
        ...
        circle: async () => (await i.e(7427).then(i.bind(i, 67427))).circleSvg,
        desktop: async () =>
        ...
        ethereum: async () =>
          (await i.e(1134).then(i.bind(i, 1134))).ethereumSvg,
        etherscan: async () =>
          (await i.e(7388).then(i.bind(i, 27388))).etherscanSvg,
        extension: async () =>
          (await i.e(1420).then(i.bind(i, 11420))).extensionSvg,
        externalLink: async () =>
          (await i.e(9667).then(i.bind(i, 69667))).externalLinkSvg,
        facebook: async () =>
        ...
        solana: async () => (await i.e(8971).then(i.bind(i, 8971))).solanaSvg,
        telegram: async () =>
        ...
        "x-mark": async () => (await i.e(8973).then(i.bind(i, 68973))).xMarkSvg,
      };
      async function S(t) {
