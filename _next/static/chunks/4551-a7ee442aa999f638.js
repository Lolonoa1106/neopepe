(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [4551],
  {
    ...
    17828: (e, t, n) => {
      ...
      let i = (0, n(64054).createAsyncLocalStorage)();
    },
    23864: (e, t, n) => {
      "use strict";
      n.d(t, { Analytics: () => g });
        ...
        return (
          ...
          (0, i.useEffect)(() => {
            ...
            !(function () {
              ...
              (i.src = n),
                ...
                l() && !1 === t.debug && (i.dataset.debug = "false"),
          ...
          (0, i.useEffect)(() => {
            e.route &&
              ...
              (function (e) {
                var t;
                let { route: n, path: i } = e;
                null == (t = window.va) ||
                  t.call(window, "pageview", { route: n, path: i });
    ...
    36450: (e, t, n) => {
      ...
      async function g(e, t) {
        ...
        try {
          ...
          if (a instanceof u.bG) throw a;
          let t = () =>
            s.map((t) =>
              (function (e, t) {
                let { chainId: n, ...i } = t,
                  r = e.getClient({ chainId: n });
                return (0, o.T)(r, f.J, "readContract")(i);
          ...
          try {
            ...
            if ("ContractFunctionExecutionError" === t.name) {
              let t = await m(e, {
                ...
                a = (0, i.IQ)((0, r.B)(t.symbol, { dir: "right" }));
              return { ...t, symbol: a };
            }
            throw t;
          }
        let g = e.getClient({ chainId: d }),
          p = (0, o.T)(g, s.r, "getBalance"),
          w = await p(
            c ? { address: n, blockNumber: c } : { address: n, blockTag: u }
          ),
          y = e.chains.find((e) => e.id === d) ?? g.chain;
        return {
          decimals: y.nativeCurrency.decimals,
          formatted: (0, a.J)(w, l(f)),
      ...
      async function m(e, t) {
        let {
          ...
          [u, d, h] = await g(e, {
            allowFailure: !1,
            contracts: [
              { ...c, functionName: "balanceOf", args: [n], chainId: i },
              { ...c, functionName: "decimals", chainId: i },
              { ...c, functionName: "symbol", chainId: i },
            ],
          }),
          f = (0, a.J)(u ?? "0", l(o ?? d));
    ...
    38779: (e) => {
      e.exports = {
        style: {
          fontFamily: "'departureMono', 'departureMono Fallback'",
          fontWeight: 400,
          fontStyle: "normal",
        },
        className: "__className_ad56bd",
        variable: "__variable_ad56bd",
      };
    },
    42714: (e, t) => {
      "use strict";
    ...
    44309: (e, t, n) => {
      ...
      class I extends b {
        constructor(e) {
          super(),
            (this.id = u.o.CONNECTOR_ID.AUTH),
            (this.name = u.o.CONNECTOR_NAMES.AUTH),
            (this.type = "AUTH"),
            (this.chain = u.o.CHAIN.SOLANA),
            (this.provider = e.w3mFrameProvider),
            (this.requestedChains = e.chains),
            (this.getActiveChain = e.getActiveChain);
        }
        get publicKey() {
          let e = h.W.state.chains.get(u.o.CHAIN.SOLANA)?.accountState?.address;
          return e ? new o.J3(e) : void 0;
        }
        get chains() {
          let e = this.provider.getAvailableChainIds();
          return this.requestedChains.filter((t) =>
            e.includes(t.caipNetworkId)
          );
        }
        async connect(e = {}) {
          let t = e.chainId || this.getActiveChain()?.id,
            n = (0, C.lj)("solana");
          if (
            (await this.provider.connect({
              chainId: (function (e) {
                if ("string" == typeof e) return `solana:${e}`;
              })(t),
            ...
            throw Error("Failed to connect to the wallet");
          return (
            this.emit("connect", this.publicKey), this.publicKey.toBase58()
          );
        }
        async disconnect() {
        ...
        async signMessage(e) {
          if (!this.publicKey) throw Error("Wallet not connected");
          let t = await this.provider.request({
            method: "solana_signMessage",
            params: {
              message: c.A.encode(e),
              pubkey: this.publicKey.toBase58(),
            },
            chainNamespace: this.chain,
          });
          return c.A.decode(t.signature);
        }
        async signTransaction(e) {
          let t = await this.provider.request({
            ...
            n = c.A.decode(t.transaction);
          return v(e) ? o.Kt.deserialize(n) : o.ZX.from(n);
        }
        async signAndSendTransaction(e, t) {
          let n = this.serializeTransaction(e);
          return (
            await this.provider.request({
              method: "solana_signAndSendTransaction",
              params: { transaction: n, options: t },
              chainNamespace: this.chain,
            })
          ).signature;
        }
        async sendTransaction(e, t, n) {
          ...
          return await t.sendRawTransaction(i.serialize(), n);
        }
        async signAllTransactions(e) {
          return (
            await this.provider.request({
              ...
              params: {
                transactions: e.map((e) => this.serializeTransaction(e)),
              },
              chainNamespace: this.chain,
            })
            ...
            let r = c.A.decode(t);
            return v(i) ? o.Kt.deserialize(r) : o.ZX.from(r);
          });
        }
        async request(e) {
        ...
        serializeTransaction(e) {
          return c.A.encode(
            new Uint8Array(e.serialize({ verifySignatures: !1 }))
          );
        }
      }
      var A = n(93813),
      ...
      class N extends b {
        constructor(e) {
          super(),
            ...
            (this.id =
              A.L.ConnectorExplorerIds[u.o.CONNECTOR_ID.COINBASE_SDK] ||
              this.name),
            (this.explorerId =
              A.L.ConnectorExplorerIds[u.o.CONNECTOR_ID.COINBASE_SDK]),
            (this.type = "ANNOUNCED"),
        ...
        get chains() {
          return this.requestedChains.filter((e) => e.id === E.tWt.id);
        }
        get publicKey() {
          return this.coinbase.publicKey;
        }
        get imageId() {
          return A.L.ConnectorImageIds[u.o.CONNECTOR_ID.COINBASE];
        }
        async connect() {
          try {
        ...
        async signAndSendTransaction(e, t) {
          return (await this.coinbase.signAndSendTransaction(e, t)).signature;
        }
        async sendTransaction(e, t, n) {
          let i = await this.signTransaction(e);
          return await t.sendRawTransaction(i.serialize(), n);
        ...
        async request(e) {
          return Promise.reject(
            Error('The "request" method is not supported on Coinbase Wallet')
          );
        }
        async getAccounts() {
          let e = this.getAccount();
          return e
            ? Promise.resolve([
                { namespace: this.chain, address: e.toBase58(), type: "eoa" },
              ])
            : Promise.resolve([]);
        }
        getAccount(e) {
          let t = this.coinbase.publicKey;
          if (e && !t) throw Error("Not connected");
          return t;
        }
      }
      var P = n(45714),
      ...
      class R extends S.F {
        constructor({ provider: e, chains: t, getActiveChain: n }) {
          super({ caipNetworks: t, namespace: "solana", provider: e }),
        ...
        get chains() {
          return this.sessionChains
            .map((e) => {
              let t = e;
              return (
                t === w.w.CHAIN_IDS.Deprecated_Mainnet
                  ? (t = w.w.CHAIN_IDS.Mainnet)
                  : t === w.w.CHAIN_IDS.Deprecated_Devnet &&
                    (t = w.w.CHAIN_IDS.Devnet),
                this.caipNetworks.find((e) => e.caipNetworkId === t)
              );
            })
            .filter(Boolean);
        }
        get icon() {
          return _.j.state.connectorImages[this.id];
        }
        get version() {
          return k(this, a, "f");
        }
        get publicKey() {
          ...
          if (e) return new o.J3(e.publicKey);
        }
        async connect() {
          await super.connectWalletConnect();
          let e = this.getAccount(!0);
          return this.emit("connect", new o.J3(e.publicKey)), e.address;
        }
        async disconnect() {
        ...
        async signTransaction(e) {
          ...
          let t = this.serializeTransaction(e),
            n = await this.internalRequest("solana_signTransaction", {
              transaction: t,
              pubkey: this.getAccount(!0).address,
              ...this.getRawRPCParams(e),
            });
          if ("signature" in n) {
            let t = c.A.decode(n.signature);
            return (
              e.addSignature(
                new o.J3(this.getAccount(!0).publicKey),
                M.from(t)
              ),
              e
            );
          }
          let i = M.from(n.transaction, "base64");
          return v(e) ? o.Kt.deserialize(new Uint8Array(i)) : o.ZX.from(i);
        }
        async signAndSendTransaction(e, t) {
          this.checkIfMethodIsSupported("solana_signAndSendTransaction");
          let n = this.serializeTransaction(e),
            i = await this.internalRequest("solana_signAndSendTransaction", {
              transaction: n,
              pubkey: this.getAccount(!0).address,
              sendOptions: t,
            });
          return this.emit("pendingTransaction", void 0), i.signature;
        }
        async sendTransaction(e, t, n) {
          let i = await this.signTransaction(e),
            r = await t.sendRawTransaction(i.serialize(), n);
          return this.emit("pendingTransaction", void 0), r;
        }
        async signAllTransactions(e) {
          try {
            return (
              ...
              (
                ...
                let r = M.from(t, "base64");
                return v(i)
                  ? o.Kt.deserialize(new Uint8Array(r))
                  : (this.emit("pendingTransaction", void 0), o.ZX.from(r));
              })
            );
          } catch (t) {
            if (t instanceof O) {
        ...
        async getAccounts() {
          return Promise.resolve(
            (this.session?.namespaces.solana?.accounts || []).map((e) => ({
              namespace: this.chain,
              address: P.C.parseCaipAddress(e).address,
              type: "eoa",
            }))
          );
        }
        internalRequest(e, t) {
          let n = this.chains.find((e) => this.getActiveChain()?.id === e.id),
            i = n?.caipNetworkId;
          switch (i) {
            case w.w.CHAIN_IDS.Mainnet:
              this.sessionChains.includes(w.w.CHAIN_IDS.Mainnet) ||
                (i = w.w.CHAIN_IDS.Deprecated_Mainnet);
              break;
            case w.w.CHAIN_IDS.Devnet:
              this.sessionChains.includes(w.w.CHAIN_IDS.Devnet) ||
                (i = w.w.CHAIN_IDS.Deprecated_Devnet);
          }
          return this.provider?.request({ method: e, params: t }, i);
        }
        get sessionChains() {
          return l.kl.getChainsFromNamespaces(this.session?.namespaces);
        }
        serializeTransaction(e) {
          return M.from(
            new Uint8Array(e.serialize({ verifySignatures: !1 }))
        ...
        getAccount(e) {
          let t = this.session?.namespaces.solana?.accounts[0];
          if (!t) {
          ...
          let n = t.split(":")[2];
          if (!n) {
            if (e) throw Error("Address not found");
            return;
          }
          return { address: n, publicKey: c.A.decode(n) };
        }
        getRawRPCParams(e) {
          return v(e)
            ? {}
            : {
                ...
                instructions: e.instructions.map((e) => ({
                  data: c.A.encode(new Uint8Array(e.data)),
                  keys: e.keys.map((e) => ({
        ...
        checkIfMethodIsSupported(e) {
          if (!this.session?.namespaces.solana?.methods.includes(e))
            throw new O(e);
        }
      }
      a = new WeakMap();
      var j = n(43217),
        D = n(70799);
      let L = (0, j.BX)({ connection: null }),
        x = {
          state: L,
          subscribeKey: (e, t) => (0, D.u$)(L, e, t),
          subscribe: (e) => (0, j.B1)(L, () => e(L)),
          setConnection(e) {
            L.connection = (0, j.KR)(e);
          },
        },
        q = { UNIT_PRICE_MICRO_LAMPORTS: 2e7, UNIT_LIMIT: 500 };
      async function U({ provider: e, to: t, value: n, connection: i }) {
        if (!e.publicKey) throw Error("No public key found");
        let r = new o.J3(t),
          a = Math.floor(n * o.Sr),
          { blockhash: s, lastValidBlockHeight: c } =
            await i.getLatestBlockhash(),
          l = [
            o.d_.setComputeUnitPrice({
              microLamports: q.UNIT_PRICE_MICRO_LAMPORTS,
            }),
            o.d_.setComputeUnitLimit({ units: q.UNIT_LIMIT }),
            o.yq.transfer({
      ...
      let W = "solana:signAndSendTransaction",
        H = "solana:signTransaction",
        F = "standard:connect",
        B = "standard:events";
      ...
      let Q = new Set(),
        G = {};
      function $(...e) {
        return (e = e.filter((e) => !Q.has(e))).length
          ? (e.forEach((e) => {
              (i = void 0), Q.add(e);
            }),
            G.register?.forEach((t) => Z(() => t(...e))),
            function () {
              e.forEach((e) => {
                (i = void 0), Q.delete(e);
              }),
                G.unregister?.forEach((t) => Z(() => t(...e)));
            })
          : () => {};
      }
      function J() {
      ...
      let er = {
        "solana:mainnet": E.tWt,
        "solana:testnet": E.gTy,
        "solana:devnet": E.Rn0,
      };
      class ea extends b {
        constructor({ wallet: e, getActiveChain: t, requestedChains: n }) {
          super(),
            (this.chain = u.o.CHAIN.SOLANA),
            (this.provider = this),
            (this.wallet = e),
            (this.getActiveChain = t),
            (this.requestedChains = n),
            this.bindEvents();
        }
        get id() {
          let e = this.name;
          return A.L.ConnectorExplorerIds[e] || e;
        }
        get name() {
          return "Trust" === this.wallet.name
            ? "Trust Wallet"
            : this.wallet.name;
        }
        get type() {
        ...
        get explorerId() {
          return A.L.ConnectorExplorerIds[this.name];
        }
        get publicKey() {
          let e = this.getAccount(!1);
          if (e) return new o.J3(e.publicKey);
        ...
        get chains() {
          return this.wallet.chains
            .map((e) =>
              this.requestedChains.find((t) => t.id === e || t.id === er[e]?.id)
            )
            .filter(Boolean);
        }
        async connect() {
          let e = this.getWalletFeature(F);
          await e.connect();
          let t = this.getAccount(!0),
            n = new o.J3(t.publicKey);
          return this.emit("connect", n), t.address;
        }
        async disconnect() {
          let e = this.getWalletFeature("standard:disconnect");
          await e.disconnect(), this.emit("disconnect", void 0);
        }
        async signMessage(e) {
          let t = this.getWalletFeature("solana:signMessage"),
            n = this.getAccount(!0),
            [i] = await t.signMessage({ message: e, account: n });
          if (!i) throw new ei("Empty result");
          return i.signature;
        }
        async signTransaction(e) {
          let t = this.getWalletFeature(H),
            n = this.getAccount(!0),
            i = this.serializeTransaction(e),
            [r] = await t.signTransaction({
              account: n,
              transaction: new Uint8Array(i),
              chain: this.getActiveChainName(),
            });
          if (!r) throw new en("Empty result");
          return (this.emit("pendingTransaction", void 0), v(e))
            ? o.Kt.deserialize(r.signedTransaction)
            : o.ZX.from(r.signedTransaction);
        }
        async signAndSendTransaction(e, t) {
          let n = this.getWalletFeature(W),
            i = this.getAccount(!0),
            [r] = await n.signAndSendTransaction({
              account: i,
              transaction: new Uint8Array(this.serializeTransaction(e)),
              options: {
                ...t,
                preflightCommitment: (function (e) {
                  switch (e) {
                    case "processed":
                    case "confirmed":
                    case "finalized":
                ...
                })(t?.preflightCommitment),
              },
              chain: this.getActiveChainName(),
            });
          if (!r) throw new et("Empty result");
          return (
            this.emit("pendingTransaction", void 0), c.A.encode(r.signature)
          );
        }
        async sendTransaction(e, t, n) {
          let i = await this.signTransaction(e);
        ...
        async signAllTransactions(e) {
          ...
          ).map(({ signedTransaction: t }, n) => {
            let i = e[n];
            if (!i) throw new en("Invalid transaction signature response");
            return (this.emit("pendingTransaction", void 0), v(i))
              ? o.Kt.deserialize(t)
              : o.ZX.from(t);
          });
        }
        async request(e) {
          return Promise.reject(new T("request"));
        }
        async getAccounts() {
          return Promise.resolve(
            this.wallet.accounts.map((e) => ({
              namespace: this.chain,
              address: e.address,
              type: "eoa",
            }))
        ...
        getWalletFeature(e) {
          if (!(e in this.wallet.features)) throw new T(e);
          return this.wallet.features[e];
        }
        getActiveChainName() {
          let e = Object.entries(er).find(
            ([, e]) => e.id === this.getActiveChain()?.id
          );
          if (!e) throw Error("Invalid chain id");
          return e[0];
        }
        bindEvents() {
          this.getWalletFeature(B).on("change", (e) => {
            if (e.accounts) {
              let t = e.accounts[0];
              t && this.emit("accountsChanged", new o.J3(t.publicKey));
            }
          });
        }
      }
      let { get: es, on: eo } = (function () {
          if (
            r ||
            ((r = Object.freeze({ register: $, get: J, on: V })),
            "undefined" == typeof window)
          )
            return r;
          let e = Object.freeze({ register: $ });
          try {
      ...
      function el(e, t, n) {
        return e
          .filter((e) => {
            var t;
            return (
              "WalletConnect" !== e.name &&
              F in (t = e).features &&
              B in t.features &&
              (W in t.features || H in t.features)
            );
          })
          .map(
            (e) => new ea({ wallet: e, requestedChains: t, getActiveChain: n })
          );
      }
      let eu = [u.o.CONNECTOR_ID.AUTH, u.o.CONNECTOR_ID.WALLET_CONNECT];
      class ed extends y.X {
        constructor(e = {}) {
          super({
            adapterType: u.o.ADAPTER_TYPES.SOLANA,
            namespace: u.o.CHAIN.SOLANA,
          }),
            (this.balancePromises = {}),
            (this.connectionSettings = e.connectionSettings || "confirmed"),
            (this.wallets = e.wallets),
            (this.registerWalletStandard = e.registerWalletStandard);
        }
        construct(e) {
          super.construct(e);
          let t = d.i.getActiveCaipNetworkId(),
            n =
              e.networks?.find((e) => e.caipNetworkId === t) || e.networks?.[0],
            i = n?.rpcUrls.default.http[0];
          i && x.setConnection(new o.Ng(i, this.connectionSettings));
        }
        setAuthProvider(e) {
          this.addConnector(
            new I({
              w3mFrameProvider: e,
              getActiveChain: () =>
                h.W.getCaipNetworkByNamespace(this.namespace),
        ...
        syncConnectors(e, t) {
          e.projectId ||
            f.h.open(p.R.ALERT_ERRORS.PROJECT_ID_NOT_CONFIGURED, "error");
          let n = () => t.getCaipNetwork(this.namespace);
          g.w.isClient() &&
            ...
            (function (e, t, n) {
              let i = [
                ...
                eo("unregister", (...e) => {
                  n(
                    ...(ec = ec.filter((t) =>
                      e.some((e) => e.name === t.wallet.name)
                    ))
                  );
                }),
              ];
              n(...(ec = el(es(), e, t))), () => i.forEach((e) => e());
            })(this.getCaipNetworks(), n, this.addConnector.bind(this));
        }
        async writeContract() {
        ...
        async getAccounts(e) {
          ...
          return t ? { accounts: await t.getAccounts() } : { accounts: [] };
        }
        async signMessage(e) {
          let t = e.provider;
          if (!t)
            throw Error(
              "connectionControllerClient:signMessage - provider is undefined"
            );
          let n = await t.signMessage(new TextEncoder().encode(e.message));
          return { signature: c.A.encode(n) };
        }
        async estimateGas(e) {
          let t = x.state.connection;
          ...
          return { gas: BigInt((await n.getEstimatedFee(t)) || 0) };
        }
        async sendTransaction(e) {
          ...
          let n = e.provider,
            i = await U({
              ...
              connection: t,
              to: e.to,
              value: Number.isNaN(Number(e.value)) ? 0 : Number(e.value),
            }),
            r = await n.sendTransaction(i, t);
          return (
            await new Promise((e) => {
              let n = setInterval(async () => {
                let i = await t.getSignatureStatus(r);
                i?.value && (clearInterval(n), e());
              }, 1e3);
            }),
            { hash: r }
          );
        ...
        async connect(e) {
          let t = this.connectors.find((t) => t.id === e.id);
          if (!t) throw Error("Provider not found");
          let n = {
              ...t,
              ...(e.id === u.o.CONNECTOR_ID.AUTH ? { provider: t } : {}),
            },
            i =
              e.rpcUrl ||
              this.getCaipNetworks()?.find((t) => t.id === e.chainId)?.rpcUrls
                .default.http[0];
          if (!i) throw Error(`RPC URL not found for chainId: ${e.chainId}`);
          let r = this.connectionManager?.getConnection({
            address: e.address,
            connectorId: t.id,
          ...
          let a = await t.connect({
            chainId: e.chainId,
            socialUri: e.socialUri,
          });
          x.setConnection(new o.Ng(i, this.connectionSettings)),
            this.emit("accountChanged", {
              address: a,
              chainId: e.chainId,
              connector: n,
            });
          let s = t.id === u.o.CONNECTOR_ID.AUTH,
            c = this.getCaipNetworks()?.find((t) => t.id === e.chainId);
          return (
            this.addConnection({
              connectorId: t.id,
              accounts: [{ address: a }],
              ...
              auth: s
                ? {
                    name: d.i.getConnectedSocialProvider(),
                    username: d.i.getConnectedSocialUsername(),
                  }
                : void 0,
            }),
            t.id !== u.o.CONNECTOR_ID.WALLET_CONNECT &&
              this.listenSolanaProviderEvents(t.id, t.provider),
            {
              id: t.id,
              address: a,
              chainId: e.chainId,
        ...
        async getBalance(e) {
          ...
          if (!t) return Promise.resolve({ balance: "0.00", symbol: "SOL" });
          let i = new o.Ng(
              n?.rpcUrls?.default?.http?.[0],
              this.connectionSettings
            ),
            r = `${n?.caipNetworkId}:${e.address}`,
            a = this.balancePromises[r];
          if (a) return a;
          let s = d.i.getNativeBalanceCacheForCaipAddress(r);
          return s
            ? { balance: s.balance, symbol: s.symbol }
            : ((this.balancePromises[r] = new Promise(async (n) => {
                try {
                  let a = (
                    (await i.getBalance(new o.J3(t))) / w.w.LAMPORTS_PER_SOL
                  ).toString();
                  if (
                    (d.i.updateNativeBalanceCache({
                      caipAddress: r,
                      balance: a,
                      symbol: e.caipNetwork?.nativeCurrency.symbol || "SOL",
                      timestamp: Date.now(),
                    }),
                    !e.caipNetwork)
                  )
                    throw Error("caipNetwork is required");
                  n({
                    balance: a,
                    symbol: e.caipNetwork?.nativeCurrency.symbol,
                  });
                } catch (e) {
                  n({ balance: "0.00", symbol: "SOL" });
                }
              }).finally(() => {
                delete this.balancePromises[r];
              })),
              this.balancePromises[r] || { balance: "0.00", symbol: "SOL" });
        }
        async switchNetwork(e) {
          await super.switchNetwork(e);
          let { caipNetwork: t } = e;
          t?.rpcUrls?.default?.http?.[0] &&
            x.setConnection(
              new o.Ng(t.rpcUrls.default.http[0], this.connectionSettings)
            );
        }
        listenProviderEvents() {}
        listenSolanaProviderEvents(e, t) {
          if (eu.includes(e)) return;
          let n = (t) => {
              this.onAccountsChanged([t.toBase58()], e, !1);
            },
        ...
        async setUniversalProvider(e) {
          ...
          let t = u.o.CONNECTOR_ID.WALLET_CONNECT;
          l.kl.listenWcProvider({
            universalProvider: e,
            namespace: u.o.CHAIN.SOLANA,
          ...
          let i = new R({
            provider: e,
            chains: this.getCaipNetworks(),
            getActiveChain: () => h.W.getCaipNetworkByNamespace(this.namespace),
          });
          if (this.registerWalletStandard) {
            let { SolanaWalletConnectStandardWallet: t } = await n
              .e(9523)
              .then(n.bind(n, 69523));
            t.register(e);
          }
          return this.addConnector(i), Promise.resolve();
        }
        async connectWalletConnect(e) {
          let t = await super.connectWalletConnect(e),
            n = this.getCaipNetworks()?.find((t) => t.id === e)?.rpcUrls.default
              .http[0],
            i = new o.Ng(n, this.connectionSettings);
          return x.setConnection(i), t;
        }
        async disconnect(e) {
          if (e.id) {
            let t = this.connectors.find((t) => t.id === e.id);
            if (!t) throw Error("Provider not found");
            let n = this.connections.find((t) =>
              m.y.isLowerCaseMatch(t.connectorId, e.id)
            );
            return (
        ...
        async syncConnections({
          connectToFirstConnector: e,
          caipNetwork: t,
          getConnectorStorageInfo: n,
        }) {
          await this.connectionManager?.syncConnections({
            ...
            getConnectionStatusInfo: n,
          }),
            e && this.emitFirstAvailableConnection();
        }
            ...
            connections: await Promise.all(
              this.connections.map(async (e) => {
                let t = this.connectors.find((t) =>
                  m.y.isLowerCaseMatch(t.id, e.connectorId)
                );
            ...
            return function (c, l) {
              if ("object" == typeof l)
                if (s.length) {
                  ...
                  let n = a(s, l);
                  if (0 !== n)
                    return i ? t.call(this, c, l, r(o, n)) : `[ref=${r(o, n)}]`;
                } else (s[0] = l), (o[0] = c);
              return n ? e.call(this, c, l) : l;
            };
          })((e, n) => {
            let i = n;
            return (
    ...
    67357: (e, t, n) => {
      ...
      let o = {
        ...
        c = function (e) {
          ...
          function l(e) {
            let s = c
                ? (0, i.jsx)(c, { isLoading: !0, pastDelay: !0, error: null })
                : null,
              o = !t.ssr || !!t.loading,
              l = o ? r.Suspense : r.Fragment,
              u = t.ssr
                ? (0, i.jsxs)(i.Fragment, {
                    children: [null, (0, i.jsx)(n, { ...e })],
                  })
      ...
      function w(e) {
        ...
        if (
          ...
          ("beforeInteractive" === l || "worker" === l) &&
            (m
              ? ((w[l] = (w[l] || []).concat([
                  { id: t, src: n, onLoad: i, onReady: r, onError: d, ...p },
                ])),
                m(w))
              : y && y()
              ? h.add(t || n)
    ...
    72962: (e, t, n) => {
      ...
      function a(e, t) {
        let { onChange: n } = t;
        return e.subscribe(() => (0, r.W)(e), n, { equalityFn: i.b });
      }
    },
    73078: (e, t, n) => {
      "use strict";
          ...
          let p = () => {
            ...
            return o(d.getItem.bind(d))(s.name)
              ...
              .then((e) => {
                var t;
                let [r, o] = e;
                if ((n((a = s.merge(o, null != (t = i()) ? t : g)), !0), r))
                  return h();
              })
              .then(() => {
                null == r || r(a, void 0),
      ...
      function y(e = {}) {
        ...
        return (0, w.U)((c) => ({
          ...
          async connect({ chainId: s, isReconnecting: o } = {}) {
            ...
            if (!l) throw new m.N();
            let h = [];
            if (o) h = await this.getAccounts().catch(() => []);
            else if (a)
              try {
                ...
                (h = e[0]?.caveats?.[0]?.value?.map((e) => (0, u.b)(e)))
                  .length > 0 && (h = await this.getAccounts());
              } catch (e) {
                if (e.code === d.vx.code) throw new d.vx(e);
                if (e.code === d.qZ.code) throw e;
              }
            try {
              h?.length ||
                o ||
                (h = (await l.request({ method: "eth_requestAccounts" })).map(
                  (e) => (0, u.b)(e)
                )),
                ...
                n ||
                  ...
                  l.on("chainChanged", n)),
                r ||
                  ((r = this.onDisconnect.bind(this)), l.on("disconnect", r));
              let f = await this.getChainId();
              if (s && f !== s) {
                let e = await this.switchChain({ chainId: s }).catch((e) => {
                  if (e.code === d.vx.code) throw e;
                  return { id: f };
                });
                f = e?.id ?? f;
              }
              return (
                ...
                { accounts: h, chainId: f }
              );
            } catch (e) {
              if (e.code === d.vx.code) throw new d.vx(e);
              if (e.code === d.qZ.code) throw new d.qZ(e);
              throw e;
            }
          },
          async disconnect() {
          ...
          async isAuthorized() {
            try {
              ...
              return !!(await (0, f.b)(() => this.getAccounts())).length;
            } catch {
              return !1;
            }
          },
            ...
            try {
              ...
              if (4902 === a.code || a?.data?.originalError?.code === 4902)
                try {
                  let a,
                    s,
                    { default: o, ...l } = i.blockExplorers ?? {};
                  e?.blockExplorerUrls
                    ? (a = e.blockExplorerUrls)
                    : o && (a = [o.url, ...Object.values(l).map((e) => e.url)]),
                    (s = e?.rpcUrls?.length
                      ? e.rpcUrls
              ...
              if (a.code === d.vx.code) throw new d.vx(a);
              throw new d.ch(a);
            }
          },
          async onAccountsChanged(e) {
            if (0 === e.length) this.onDisconnect();
              ...
              c.emitter.emit("change", { accounts: e.map((e) => (0, u.b)(e)) });
          },
          onChainChanged(e) {
            let t = Number(e);
            c.emitter.emit("change", { chainId: t });
        ...
        return (
          (n =
            "object" == typeof i && "local" === i.type
              ? e.getClient()
              : await (0, M.r)(e, { account: i, connector: r })),
          (0, _.T)(
            n,
            O.l,
            "signMessage"
      ...
      async function L(e, t) {
        ...
        let o = (0, _.T)(n, D.v, "sendTransaction");
        return await o({
          ...s,
          ...(i ? { account: i } : {}),
          chain: r ? { id: r } : null,
      ...
      async function H(e, t) {
        let { chainId: n, timeout: i = 0, ...r } = t,
          ...
          s = (0, _.T)(a, q.n, "waitForTransactionReceipt"),
          o = await s({ ...r, timeout: i });
        if ("reverted" === o.status) {
          let e = (0, _.T)(a, U.x, "getTransaction"),
          ...
          throw Error(
            i?.data ? (0, x.IQ)(`0x${i.data.substring(138)}`) : "unknown reason"
          );
        }
      ...
      async function B(e, t) {
        ...
        let o = (0, _.T)(n, F.E, "writeContract");
        return await o({
          ...s,
          ...(i ? { account: i } : {}),
          chain: r ? { id: r } : null,
      ...
      async function z(e, t) {
        ...
        return (0, _.T)(s, K.Q, "estimateGas")({ ...a, account: n });
      }
      var Q = n(97587);
      async function G(e, t) {
        let n;
      ...
      async function $(e, t) {
        ...
        if (r) {
          let e = r.connector;
          if (!e.switchChain) throw new m.V({ connector: e });
          return await e.switchChain({
            addEthereumChainParameter: n,
            chainId: i,
          });
        }
        let a = e.chains.find((e) => e.id === i);
        if (!a) throw new p.nk();
        return e.setState((e) => ({ ...e, chainId: i })), a;
      }
      var J = n(75483),
        V = n(36450),
        Z = n(37968),
      ...
      function ew(e, t) {
        ...
        return (0, w.U)((e) => ({
          ...
          async connect({ ...e } = {}) {
            try {
              let t = es.W.getCaipNetworks(),
                n = await this.getProvider();
              if (!n) throw new m.N();
              s || ((s = this.onDisplayUri), n.on("display_uri", s));
              let l = await this.isChainsStale();
              n.session && l && (await n.disconnect());
              let u = ea.H.state.universalProviderConfigOverride;
              if (!n.session || l) {
                let i = ee.kl.createNamespaces(t, u);
                await n.connect({
              ...
              let d = await this.getAccounts(),
                ...
                g = f?.some((e) => Number(e.split(":")[1]) === h),
                p = 1;
              g ? (p = h) : f?.[0] && (p = Number(f[0].split(":")[1])),
              ...
              let w = u?.defaultChain;
              return (
                n.setDefaultChain(w ?? `eip155:${p}`),
                { accounts: d, chainId: p }
              );
            } catch (e) {
          ...
          async getAccounts() {
            ...
            let t = e?.session?.namespaces[et.o.CHAIN.EVM]?.accounts,
              n = t?.map((e) => e.split(":")[2]) ?? [],
              i = new Set();
            return n.filter((e) => {
              let t = e?.toLowerCase();
          ...
          async getProvider({ chainId: e } = {}) {
            ...
            let i = er.i.getActiveNamespace(),
              r = t.getCaipNetwork()?.id;
            if (e && r !== e && i) {
              let e = er.i.getStoredActiveCaipNetworkId(),
                n = t.getCaipNetworks(i),
                r = n?.find((t) => t.id === e);
              r &&
                r.chainNamespace === et.o.CHAIN.EVM &&
                (await this.switchChain?.({ chainId: Number(r.id) }));
            }
            return n;
          },
          async getChainId() {
            let e = t.getCaipNetwork(et.o.CHAIN.EVM)?.id;
            if (e) return e;
            let n = await this.getProvider(),
              i = n.session?.namespaces[et.o.CHAIN.EVM]?.chains?.[0],
              r = es.W.getCaipNetworks().find((e) => e.id === i);
            return r?.id;
          },
          async isAuthorized() {
            try {
          ...
          async switchChain({ addEthereumChainParameter: t, chainId: n }) {
            ...
            if (!i) throw new m.N();
            let r = es.W.getCaipNetworks().find((e) => e.id === n);
            if (!r) throw new d.ch(new p.nk());
            try {
              await i.request({
                method: "wallet_switchEthereumChain",
                params: [{ chainId: (0, g.cK)(n) }],
              }),
              ...
              if (/(?:user rejected)/iu.test(e.message)) throw new d.vx(e);
              try {
                let e;
          ...
          onConnect(e) {
            this.setRequestedChainsIds(
              es.W.getCaipNetworks().map((e) => Number(e.id))
            );
          },
          ...
          getNamespaceChainsIds() {
            ...
            let e = n?.session?.namespaces[et.o.CHAIN.EVM]?.accounts;
      ...
      n(96147), (ew.type = "walletConnect");
      var ey = n(43217),
        ev = n(70799);
      let eC = (0, ey.BX)({ pendingTransactions: 0 }),
        eb = {
          state: eC,
          subscribeKey: (e, t) => (0, ev.u$)(eC, e, t),
          increase(e) {
            eC[e] += 1;
          },
          decrease(e) {
      ...
      let eE = { enable: !1, pollingInterval: 3e4 };
      class eN extends eu.X {
        constructor(e) {
          let t = eo.R.extendCaipNetworks(e.networks, {
          ...
          super(),
            (this.balancePromises = {}),
            (this.namespace = et.o.CHAIN.EVM),
            (this.adapterType = et.o.ADAPTER_TYPES.WAGMI),
        ...
        async getAccounts(e) {
          ...
          return Promise.resolve({
            accounts: [...new Set(n || [i])].map((e) =>
              ei.w.createAccount("eip155", e || "", "eoa")
            ),
          });
        }
        checkChainId() {
        ...
        createConfig(e) {
          this.wagmiChains = e.networks.filter(
            (e) => e.chainNamespace === et.o.CHAIN.EVM
          );
          let t = {},
            n = [...(e.connectors ?? [])];
          this.wagmiChains.forEach((n) => {
            let i = e.transports?.[n.id],
              r = eo.R.getCaipNetworkId(n);
            i
              ? (t[n.id] = eo.R.extendWagmiTransports(n, e.projectId, i))
              : (t[n.id] = eo.R.getViemTransport(
                  n,
                  e.projectId,
                  e.customRpcUrls?.[r]
                ));
            ...
            (this.wagmiConfig = (function (e) {
              let t,
                {
                  ...
                  storage: r = (0, A.wE)({ storage: (0, A.XB)() }),
                ...
                g = (0, l.y)(() => {
                  ...
                  if (!u && h)
                    for (let n of h.getProviders())
                      t.has(n.info.rdns) || e.push(m(w(n)));
                  return e;
                });
              function m(e) {
                let t = new I(
              ...
              function w(e) {
                let { info: t } = e,
                  n = e.provider;
                return y({ target: { ...t, id: t.rdns, provider: n } });
              }
              let v = new Map();
              function C() {
                return {
              ...
              let b = "0.0.0-canary-";
              t = N.r.startsWith(b)
                ? Number.parseInt(N.r.replace(b, ""))
                : Number.parseInt(N.r.split(".")[0] ?? "0");
              let P = (0, l.y)(
                s(
                  r
                    ? c(C, {
                  ...
                  if (n) {
                    ...
                    e.emitter.listenerCount("change") &&
                      ...
                      e.emitter.listenerCount("disconnect") &&
                        n.connector.emitter.off("disconnect", O),
              ...
              return (
                ...
                }),
                {
                  ...
                  getClient: function (e = {}) {
                    ...
                    {
                      let e = v.get(P.getState().chainId);
                      if (e && !i) return e;
                      if (!i) throw new p.nk();
                    }
                    {
                  ...
                  _internal: {
                    ...
                    connectors: {
                      ...
                      setState: (e) =>
                        g.setState(
                          "function" == typeof e ? e(g.getState()) : e,
                          !0
                        ),
                      subscribe: (e) => g.subscribe(e),
                    },
                    events: { change: S, connect: T, disconnect: O },
                  },
                }
              );
            })({
          ...
          this.unwatchPendingTransactions = (function (e, t) {
            let n,
              ...
              s = (t) => {
                ...
                return (n = (0, _.T)(i, P.u, "watchPendingTransactions")(a));
              },
              o = s(t.chainId);
            return (
              r &&
            ...
            onTransactions: () => {
              this.emit("pendingTransactions"),
                eb.increase("pendingTransactions");
            },
          });
          let e = eb.subscribeKey("pendingTransactions", (t) => {
            t >= et.o.LIMITS.PENDING_TRANSACTIONS &&
                  ...
                  this.addConnection(
                    ...e.map((e) => {
                      let t = this.getCaipNetworks().find(
                        ...
                        n = e.connector.id === et.o.CONNECTOR_ID.AUTH;
                      return {
                        ...
                        auth: n
                          ? {
                              name: er.i.getConnectedSocialProvider(),
                              username: er.i.getConnectedSocialUsername(),
                            }
                          : void 0,
                      };
                    })
        ...
        async addThirdPartyConnectors(e) {
          ...
          if (!1 !== e.enableCoinbase) {
            let e = await eA(this.wagmiConfig.connectors);
            e && t.push(e);
          }
          let n = await eI(this.wagmiConfig.connectors);
          n && t.push(n),
            await Promise.all(
              t.map((t) => {
        ...
        addWagmiConnectors(e, t) {
          let n = [];
          !1 !== e.enableWalletConnect && n.push(ew(e, t)),
            !1 !== e.enableEIP6963 && n.push(y({ shimDisconnect: !0 }));
            ...
            n.push(
              (function (e) {
                let t,
                  ...
                  i = [];
                function r(e) {
                  return en.L.parseEvmChainId(e) || 1;
                }
                async function a(n = {}) {
                  let s =
                      (t ||
                        (t = em.v.getInstance({
                          ...
                          chainId: es.W.getActiveCaipNetwork()?.caipNetworkId,
                          enableLogger: e.options.enableAuthLogger,
                          onTimeout: (e) => {
                            "iframe_load_failed" === e
                              ? eh.h.open(
                                  ep.R.ALERT_ERRORS.IFRAME_LOAD_FAILED,
                                  "error"
                                )
                              : "iframe_request_timeout" === e
                              ? eh.h.open(
                                  ep.R.ALERT_ERRORS.IFRAME_REQUEST_TIMEOUT,
                                  "error"
                                )
                              : "unverified_domain" === e &&
                                eh.h.open(
                                  ep.R.ALERT_ERRORS.UNVERIFIED_DOMAIN,
                                  "error"
                                );
                          },
                          abortController: ep.R.EmbeddedWalletAbortController,
                          getActiveCaipNetwork: (e) =>
                            es.W.getActiveCaipNetwork(e),
                        })),
                      t),
                    o = n.chainId;
                  if (n.isReconnecting) {
                    let t = en.L.parseEvmChainId(s.getLastUsedChainId() || ""),
                      n = e.chains?.[0].id;
                    if (!(o = t || n))
                      throw Error("ChainId not found in provider");
                  }
                  let c = (0, ef.lj)("eip155"),
                    {
                      address: l,
                      chainId: u,
                      accounts: d,
                ...
                return (0, w.U)((t) => ({
                  id: et.o.CONNECTOR_ID.AUTH,
                  name: et.o.CONNECTOR_NAMES.AUTH,
                  type: "AUTH",
                  chain: et.o.CHAIN.EVM,
                  async connect(e = {}) {
                    if (n) return n;
                    n ||
                      (n = new Promise((t) => {
                  ...
                  async getProvider() {
                    return (
                      this.provider ||
                        (this.provider = em.v.getInstance({
                          projectId: e.options.projectId,
                          chainId: es.W.getActiveCaipNetwork()?.caipNetworkId,
                          enableLogger: e.options.enableAuthLogger,
                          abortController: ep.R.EmbeddedWalletAbortController,
                  ...
                  async isAuthorized() {
                    let e = es.W.state.activeChain === et.o.CHAIN.EVM;
                    return (
                      (!et.o.AUTH_CONNECTOR_SUPPORTED_CHAINS.some(
                        (e) => eg.a.getConnectorId(e) === et.o.CONNECTOR_ID.AUTH
                      ) ||
                        !!e) &&
                      Promise.resolve(
                  ...
                  async switchChain({ chainId: e }) {
                    try {
                      ...
                      if (!n)
                        throw new d.ch(Error("chain not found on connector."));
                      ...
                      if (e instanceof Error) throw new d.ch(e);
                      throw e;
                    }
                  },
                  onAccountsChanged(e) {
                    0 === e.length
                      ? this.onDisconnect()
                      : t.emitter.emit("change", { accounts: e.map(u.b) });
                  },
                  onChainChanged(e) {
                    let n = Number(e);
        ...
        async handleAccountChanged({ address: e, chainId: t, connector: n }) {
          ...
          this.emit("accountChanged", {
            ...
            connector: {
              id: n.id,
              name: ec.L.ConnectorNamesMap[n.id] ?? n.name,
              imageId: ec.L.ConnectorImageIds[n.id],
              type: ec.L.ConnectorTypesMap[n.type] ?? "EXTERNAL",
              info:
                n.id === et.o.CONNECTOR_ID.INJECTED ? void 0 : { rdns: n.id },
              provider: i,
        ...
        async signMessage(e) {
          try {
            return {
              signature: await k(this.wagmiConfig, {
                message: e.message,
                account: e.address,
              }),
            };
        ...
        async sendTransaction(e) {
          ...
          await j(this.wagmiConfig, i);
          let a = await L(this.wagmiConfig, i);
          return (
        ...
        async writeContract(e) {
          let { caipNetwork: t, ...n } = e,
            i = Number(en.L.caipNetworkIdToNumber(t.caipNetworkId));
          return {
            hash: await B(this.wagmiConfig, {
        ...
        parseUnits(e) {
          return (0, X.X)(e.value, e.decimals);
        }
        formatUnits(e) {
        ...
        async addWagmiConnector(e, t) {
          if (
            (e.type === et.o.CONNECTOR_ID.INJECTED && !1 === t.enableEIP6963) ||
            e.id === et.o.CONNECTOR_ID.AUTH ||
            e.id === et.o.CONNECTOR_ID.WALLET_CONNECT
          )
            return;
          let n = await e.getProvider().catch(() => void 0);
          this.addConnector({
            id: e.id,
            explorerId: ec.L.ConnectorExplorerIds[e.id],
            imageUrl: t?.connectorImages?.[e.id] ?? e.icon,
            name: ec.L.ConnectorNamesMap[e.id] ?? e.name,
            imageId: ec.L.ConnectorImageIds[e.id],
            type: ec.L.ConnectorTypesMap[e.type] ?? "EXTERNAL",
            info: e.id === et.o.CONNECTOR_ID.INJECTED ? void 0 : { rdns: e.id },
            provider: n,
            chain: this.namespace,
            chains: [],
          });
        ...
        async syncConnection(e) {
          let { id: t, chainId: n } = e,
            i = (0, Q.W)(this.wagmiConfig).find((e) => e.connector.id === t),
            r = this.getWagmiConnector(t),
            a = await r?.getProvider();
          if (
            ei.w.isSafeApp() &&
            t === et.o.CONNECTOR_ID.SAFE &&
            !i?.accounts.length
          ) {
            let e = this.getWagmiConnector("safe");
            if (e) {
              let t = await G(this.wagmiConfig, {
                  connector: e,
                  chainId: Number(n),
                }),
        ...
        async connectWalletConnect(e) {
          ...
          let i = await G(this.wagmiConfig, {
            connector: n,
            chainId: e ? Number(e) : void 0,
          });
          return (
            i.chainId !== Number(e) &&
              (await $(this.wagmiConfig, { chainId: i.chainId })),
        ...
        async connect(e) {
          ...
          i &&
            a &&
            c.id === et.o.CONNECTOR_ID.EIP6963 &&
            c.setEip6963Wallet?.({ provider: i, info: a });
          let l = this.wagmiConfig.state?.connections?.get(c.uid);
          if (l) {
            await this.wagmiConfig.storage?.setItem("recentConnectorId", c.id);
            let e = [...l.accounts].sort((e, t) =>
              el.y.isLowerCaseMatch(e, n) ? -1 : +!!el.y.isLowerCaseMatch(t, n)
            );
            return (
              ...
              { address: e[0], chainId: l.chainId, provider: i, type: r, id: t }
            );
          }
          let u = await G(this.wagmiConfig, {
            connector: c,
            chainId: s ? Number(s) : void 0,
            socialUri: o,
          });
          return {
            address: u.accounts[0],
            chainId: u.chainId,
            provider: i,
            type: r,
            id: t,
        ...
        async reconnect(e) {
          ...
          await (0, J.M)(this.wagmiConfig, { connectors: [n] });
        }
        async getBalance(e) {
          let t = e.address,
            n = this.getCaipNetworks().find((t) => t.id === e.chainId);
        ...
        async disconnect(e) {
          if (e.id) {
            let t = this.getWagmiConnector(e.id),
              n = (0, Q.W)(this.wagmiConfig).find((t) =>
                el.y.isLowerCaseMatch(t.connector.id, e.id)
              );
            return (await (0, Z.Z)(this.wagmiConfig, { connector: t }),
            !1 === ea.H.state.enableReconnect && this.deleteConnection(e.id),
            n)
              ? {
                  connections: [
                    {
        ...
        async disconnectAll() {
          let e = (0, Q.W)(this.wagmiConfig),
            t = await Promise.allSettled(
              e.map(async (e) => {
                let t = this.getWagmiConnector(e.connector.id);
                return (
                  t && (await (0, Z.Z)(this.wagmiConfig, { connector: t })), e
                );
              })
            );
          return (
        ...
        async switchNetwork(e) {
          let { caipNetwork: t } = e;
          await $(this.wagmiConfig, {
            chainId: t.id,
            addEthereumChainParameter: {
              chainName: t.name,
              nativeCurrency: t.nativeCurrency,
              rpcUrls: [t.rpcUrls?.chainDefault?.http?.[0] ?? ""],
              blockExplorerUrls: [t.blockExplorers?.default.url ?? ""],
              iconUrls: [t.assets?.imageUrl ?? ""],
            },
          }),
            await super.switchNetwork(e);
        }
        async getCapabilities(e) {
          ...
          let t = (0, Q.W)(this.wagmiConfig)[0],
        ...
        setAuthProvider(e) {
          this.addConnector({
            ...
            name: et.o.CONNECTOR_NAMES.AUTH,
            provider: e,
            imageId: ec.L.ConnectorImageIds[et.o.CONNECTOR_ID.AUTH],
            chain: this.namespace,
            chains: [],
          });
        }
          ...
          return (
            e.on("connect", () => {
              ...
              if (t && !e.find((e) => e.connector.id === t.id)) {
                if ("eip155" === es.W.state.activeChain) return;
                (0, J.M)(this.wagmiConfig, { connectors: [t] });
              }
            }),
            this.addConnector(
              new ed.F({
    ...
    87017: (e, t, n) => {
      ...
      var i = n(52020),
        ...
        l = class extends s.Q {
          ...
          runNext(e) {
            ...
            {
              let n = this.#s.get(t)?.find((t) => t !== e && t.state.isPaused);
            ...
            let r = t.options,
              ...
              u = async () => {
                ...
                if (a && s.length) {
                  ...
                  let t = e ?? s.length;
                  do {
                    let e = 0 === l ? o[0] ?? r.initialPageParam : g(r, c);
                    if (l > 0 && null == e) break;
                    (c = await h(c, e)), l++;
                  } while (l < t);
                }
      ...
      function g(e, { pages: t, pageParams: n }) {
        let i = t.length - 1;
      ...
      var p = class {
        ...
        mount() {
          this.#h++,
            1 === this.#h &&
              ((this.#f = d.m.subscribe(async (e) => {
                e && (await this.resumePausedMutations(), this.#c.onFocus());
              })),
              (this.#g = h.t.subscribe(async (e) => {
        ...
        cancelQueries(e, t = {}) {
          let n = { revert: !0, ...t };
          return Promise.all(
            a.jG.batch(() => this.#c.findAll(e).map((e) => e.cancel(n)))
          )
            .then(i.lQ)
            .catch(i.lQ);
        }
        ...
        setMutationDefaults(e, t) {
          this.#d.set((0, i.EN)(e), { mutationKey: e, defaultOptions: t });
        }
    ...
    91281: (e, t, n) => {
      ...
      let a = {
        ...
        ROOT_DOMAIN_ACCOUNT: new i.J3(
          "58PwtjSDuFHuUkYjH9BYnnQKHfwo9reZhC2zMJv9JPkx"
        ),
        NAME_PROGRAM_ID: new i.J3(
          "namesLPneVptA9Z5rqUDD9tMTWEJwofgaYwp8cawRkX"
        ),
        REVERSE_LOOKUP_CLASS: new i.J3(
        ...
        DEFAULT_CHAIN: {
          ...
          name: "Solana",
          chainNamespace: r.o.CHAIN.SOLANA,
          nativeCurrency: { name: "Solana", decimals: 9, symbol: "SOL" },
          blockExplorers: {
            default: { name: "Solscan", url: "https://solscan.io" },
          },
          rpcUrls: { default: { http: [`${r.o.BLOCKCHAIN_API_RPC_URL}/v1`] } },
        },
        CHAIN_IDS: {
    ...
    97587: (e, t, n) => {
      ...
      function a(e) {
        ...
        return "reconnecting" === e.state.status || (0, i.b)(r, t)
          ? r
          : ((r = t), t);
      }
    },
