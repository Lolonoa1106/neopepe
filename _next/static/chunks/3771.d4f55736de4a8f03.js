...
`;
    ...
    63771: (e, t, a) => {
      a.r(t), a.d(t, { W3mWalletReceiveView: () => $ });
      var i = a(28312),
        r = a(745),
        o = a(51882),
        s = a(11076),
...
`;
    ...
    `;
      ...
      ${e?.map(
        (e) =>
          (0,
          i.qy)` <wui-flex class="network-icon"> <wui-image src=${e}></wui-image> </wui-flex>`
      )}
    </wui-flex>`;
        }
      };
      (f.styles = [g.W5, g.fD, b]),
        m([(0, r.MZ)({ type: Array })], f.prototype, "networkImages", void 0),
        m([(0, r.MZ)()], f.prototype, "text", void 0),
        (f = m([(0, v.E)("wui-compatible-network")], f)),
        a(98160),
        a(4146),
        a(22724);
      var y = a(45312);
...
`;
      ...
      ${this.networkTemplate()}
        ...
        networkTemplate() {
          let e = n.W.getAllRequestedCaipNetworks(),
            ...
            r = e.filter((e) => e?.chainNamespace === a?.chainNamespace);
          if (
            (0, u.lj)(a?.chainNamespace) === y.Vl.ACCOUNT_TYPES.SMART_ACCOUNT &&
            t
          )
            return a
    ...
    ></wui-compatible-network>`;
        ...
        onReceiveClick() {
          w.I.push("WalletCompatibleNetworks");
        }
        onCopyClick() {
          try {
            this.address &&
              (p.w.copyToClopboard(this.address),
      ...
      ($.styles = x),
        k([(0, r.wk)()], $.prototype, "address", void 0),
        k([(0, r.wk)()], $.prototype, "profileName", void 0),
        k([(0, r.wk)()], $.prototype, "network", void 0),
        ($ = k([(0, h.EM)("w3m-wallet-receive-view")], $));
    },
  },
]);
