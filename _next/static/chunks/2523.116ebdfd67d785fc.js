...
`;
      ...
      (l.styles = [a.W5, a.ck, n]),
        ...
        c([(0, o.MZ)()], l.prototype, "objectFit", void 0),
    ...
    92523: (e, t, i) => {
      i.r(t),
        i.d(t, {
          W3mBuyInProgressView: () => V,
          W3mOnRampActivityView: () => b,
          W3mOnRampProvidersView: () => G,
...
`;
    ...
    ></wui-icon-box>`;
      ...
      (g.styles = [w]),
        m([(0, o.MZ)({ type: Boolean })], g.prototype, "disabled", void 0),
        m([(0, o.MZ)()], g.prototype, "color", void 0),
        m([(0, o.MZ)()], g.prototype, "label", void 0),
        m([(0, o.MZ)()], g.prototype, "purchaseValue", void 0),
        m([(0, o.MZ)()], g.prototype, "purchaseCurrency", void 0),
        m([(0, o.MZ)()], g.prototype, "date", void 0),
        m([(0, o.MZ)({ type: Boolean })], g.prototype, "completed", void 0),
        m([(0, o.MZ)({ type: Boolean })], g.prototype, "inProgress", void 0),
        m([(0, o.MZ)({ type: Boolean })], g.prototype, "failed", void 0),
        m([(0, o.MZ)()], g.prototype, "onClick", void 0),
        m([(0, o.MZ)()], g.prototype, "symbol", void 0),
        m([(0, o.MZ)()], g.prototype, "icon", void 0),
        (g = m([(0, d.EM)("w3m-onramp-activity-item")], g));
      let y = (0, r.AH)`
  :host > wui-flex {
    height: 500px;
    overflow-y: auto;
...
`,
      ...
      How does it work?
          ...
          onWhatIsBuy() {
            ...
            A.E.sendEvent({
              ...
              properties: {
                isSmartAccount:
                  (0, P.lj)(e) === W.Vl.ACCOUNT_TYPES.SMART_ACCOUNT,
              },
            }),
              $.I.push("WhatIsABuy");
          }
          ...
          if (
            ...
            for (var n = e.length - 1; n >= 0; n--)
              (o = e[n]) &&
                (s = (a < 3 ? o(s) : a > 3 ? o(t, i, s) : o(t, i)) || s);
          return a > 3 && s && Object.defineProperty(t, i, s), s;
        })([(0, d.EM)("w3m-onramp-providers-footer")], D));
    ...
    `;
          ...
          n.aG.setSelectedProvider(e),
            ...
            A.E.sendEvent({
              ...
              properties: {
                provider: e.name,
                isSmartAccount:
                  (0, P.lj)(t) === W.Vl.ACCOUNT_TYPES.SMART_ACCOUNT,
              },
            });
        }
        async getCoinbaseOnRampURL() {
          ...
          let i =
              O.oU.WC_COINBASE_PAY_SDK_CHAIN_NAME_MAP[t.name] ??
              O.oU.WC_COINBASE_PAY_SDK_FALLBACK_CHAIN,
            r = n.aG.state.purchaseCurrency,
            o = r
              ? [r.symbol]
              : n.aG.state.purchaseCurrencies.map((e) => e.symbol);
          return await j.T.generateOnRampURL({
            defaultNetwork: i,
            destinationWallets: [
              {
                address: e,
                blockchains: O.oU.WC_COINBASE_PAY_SDK_CHAINS,
                assets: o,
              },
            ],
            partnerUserId: e,
      ...
      N([(0, o.wk)()], G.prototype, "providers", void 0),
        (G = N([(0, d.EM)("w3m-onramp-providers-view")], G));
      let z = (0, r.AH)`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
    ...
    `;
        ...
        async watchCoinbaseTransactions() {
          try {
            ...
            if (!e) throw Error("No address found");
            (
              await j.T.fetchTransactions({ account: e, onramp: "coinbase" })
            ).data.filter(
              (e) =>
      ...
      Try again
        ...
        loaderTemplate() {
          let e = F.W.state.themeVariables["--w3m-border-radius-master"],
        ...
        onCopyUri() {
          if (!this.selectedOnRampProvider?.url) {
            Z.P.showError("No link found"), $.I.goBack();
            return;
          }
          try {
            R.w.copyToClopboard(this.selectedOnRampProvider.url),
              Z.P.showSuccess("Link copied");
          } catch {
      ...
      (V.styles = H),
        K([(0, o.wk)()], V.prototype, "intervalId", void 0),
        K([(0, o.wk)()], V.prototype, "selectedOnRampProvider", void 0),
        K([(0, o.wk)()], V.prototype, "uri", void 0),
        K([(0, o.wk)()], V.prototype, "ready", void 0),
        K([(0, o.wk)()], V.prototype, "showRetry", void 0),
        K([(0, o.wk)()], V.prototype, "buffering", void 0),
        K([(0, o.wk)()], V.prototype, "error", void 0),
        K([(0, o.wk)()], V.prototype, "startTime", void 0),
        K([(0, o.MZ)({ type: Boolean })], V.prototype, "isMobile", void 0),
        K([(0, o.MZ)()], V.prototype, "onRetry", void 0),
        (V = K([(0, d.EM)("w3m-buy-in-progress-view")], V));
      let J = class extends r.WF {
        render() {
          return (0, r.qy)`
      <wui-flex
        flexDirection="column"
        ...
        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
          ...
          for (var n = e.length - 1; n >= 0; n--)
            (o = e[n]) &&
              (s = (a < 3 ? o(s) : a > 3 ? o(t, i, s) : o(t, i)) || s);
        return a > 3 && s && Object.defineProperty(t, i, s), s;
      })([(0, d.EM)("w3m-what-is-a-buy-view")], J)),
        i(65759);
      let Y = (0, r.AH)`
  :host {
    width: 100%;
...
`;
      ...
      (X.styles = Y),
        Q([(0, o.MZ)({ type: String })], X.prototype, "type", void 0),
        Q([(0, o.MZ)({ type: Number })], X.prototype, "value", void 0),
        Q([(0, o.wk)()], X.prototype, "currencies", void 0),
        Q([(0, o.wk)()], X.prototype, "selectedCurrency", void 0),
        Q([(0, o.wk)()], X.prototype, "currencyImages", void 0),
        Q([(0, o.wk)()], X.prototype, "tokenImages", void 0),
        (X = Q([(0, d.EM)("w3m-onramp-input")], X));
      let ee = (0, r.AH)`
  :host > wui-flex {
    width: 100%;
    max-width: 360px;
...
`;
      ...
      let ei = { USD: "$", EUR: "€", GBP: "\xa3" },
        er = [100, 250, 500, 1e3],
        eo = class extends r.WF {
          constructor() {
            super(),
              (this.unsubscribe = []),
              (this.disabled = !1),
          ...
          <wui-flex justifyContent="space-evenly" class="amounts-container" gap="xs">
            ${er.map(
              (e) => (0, r.qy)`<wui-button
                  ...
                  >${`${
                    ei[this.paymentCurrency?.id || "USD"]
                  } ${e}`}</wui-button
                >`
            )}
          </wui-flex>
    ...
    `;
      ...
      (eo.styles = ee),
        et([(0, o.MZ)({ type: Boolean })], eo.prototype, "disabled", void 0),
        et([(0, o.wk)()], eo.prototype, "caipAddress", void 0),
        et([(0, o.wk)()], eo.prototype, "loading", void 0),
        et([(0, o.wk)()], eo.prototype, "paymentCurrency", void 0),
        et([(0, o.wk)()], eo.prototype, "paymentAmount", void 0),
        et([(0, o.wk)()], eo.prototype, "purchaseAmount", void 0),
        et([(0, o.wk)()], eo.prototype, "quoteLoading", void 0),
        (eo = et([(0, d.EM)("w3m-onramp-widget")], eo));
    },
  },
]);
