...
`;
      ...
      (l.styles = [a.W5, n]),
        ...
        (l = c([(0, s.E)("wui-loading-spinner")], l));
    },
    13998: (e, t, o) => {
      o(48252);
    },
...
`;
    ...
    `;
      ...
      (h.styles = [a.W5, a.fD, n]),
        ...
        c([(0, r.MZ)({ type: Boolean })], h.prototype, "fullWidth", void 0),
        c([(0, r.MZ)({ type: Boolean })], h.prototype, "loading", void 0),
        c([(0, r.MZ)()], h.prototype, "variant", void 0),
        c([(0, r.MZ)({ type: Boolean })], h.prototype, "hasIconLeft", void 0),
        c([(0, r.MZ)({ type: Boolean })], h.prototype, "hasIconRight", void 0),
        c([(0, r.MZ)()], h.prototype, "borderRadius", void 0),
        c([(0, r.MZ)()], h.prototype, "textVariant", void 0),
        (h = c([(0, s.E)("wui-button")], h));
    },
    23050: (e, t, o) => {
      var i = o(28312),
        r = o(745);
...
`;
      ...
      (l.styles = [a.W5, n]),
        c([(0, r.MZ)()], l.prototype, "logo", void 0),
        (l = c([(0, s.E)("wui-logo")], l));
    },
    33559: (e, t, o) => {
      o.d(t, { Up: () => g });
      var i = o(60500),
      ...
      async function p(e) {
        ...
        try {
          ...
          o?.close(), l.P.showError(e?.message);
        }
      }
      async function g(e) {
    ...
    47113: (e, t, o) => {
      o.r(t),
        o.d(t, {
          W3mConnectSocialsView: () => m,
          W3mConnectingFarcasterView: () => M,
...
`;
      ...
      ${e.map(
        ...
        async handlePwaFrameLoad() {
          if (g.w.isPWA()) {
            this.isPwaLoading = !0;
            try {
              this.authConnector?.provider instanceof w.Y &&
      ...
      (f.styles = v),
        ...
        (f = b([(0, c.EM)("w3m-social-login-list")], f));
      let x = (0, i.AH)`
  wui-flex {
...
`;
      ...
      >
        <w3m-social-login-list tabIdx=${(0, a.J)(
          s ? -1 : void 0
    ...
    `;
      ...
      (m.styles = x),
        y([(0, r.wk)()], m.prototype, "checked", void 0),
        (m = y([(0, c.EM)("w3m-connect-socials-view")], m));
      var k = o(11076),
        C = o(14796),
        $ = o(90906),
        P = o(32836),
        ...
        R = o(33806),
        I = o(7478);
      o(36698), o(19284), o(23050), o(22724);
      var W = o(28307),
        z = o(26128);
      let O = (0, i.AH)`
  wui-logo {
...
`;
      ...
      let T = class extends i.WF {
        constructor() {
          super(),
            ...
            (this.remoteFeatures = n.H.state.remoteFeatures),
            (this.address = k.U.state.address),
            (this.connectionsByNamespace = C.x.getConnections(
              $.W.state.activeChain
            )),
            ...
            (this.handleSocialConnection = async (e) => {
              if (e.data?.resultUri)
                if (e.origin === z.o.SECURE_SITE_ORIGIN) {
                  ...
                  try {
                    if (this.authConnector && !this.connecting) {
                      this.socialWindow &&
                        ...
                        k.U.setSocialWindow(void 0, $.W.state.activeChain)),
                        (this.connecting = !0),
                        this.updateMessage();
                      ...
                      this.socialProvider &&
                        ...
                        this.socialProvider &&
                          (E.i.setConnectedSocialProvider(this.socialProvider),
                          P.E.sendEvent({
                            type: "track",
            ...
            W.R.EmbeddedWalletAbortController.signal.addEventListener(
              "abort",
              () => {
                this.socialWindow &&
                  (this.socialWindow.close(),
            ...
            this.unsubscribe.push(
              ...
              k.U.subscribeKey("address", (e) => {
                let t = this.remoteFeatures?.multiWallet;
                e &&
                  e !== this.address &&
                  (this.hasMultipleConnections && t
                    ? (d.I.replace("ProfileWallets"),
                      S.P.showSuccess("New Wallet Added"))
                    : (R.W.state.open || n.H.state.enableEmbedded) &&
                      R.W.close());
              })
            ),
    ...
    `;
      ...
      (T.styles = O),
        ...
        L([(0, r.wk)()], T.prototype, "remoteFeatures", void 0),
        (T = L([(0, c.EM)("w3m-connecting-social-view")], T)),
        o(54279),
        o(21330),
        o(82786),
        o(4146),
          ...
          if (this.authConnector)
            try {
              await this.authConnector?.provider.connectFarcaster(),
                ...
                (this.loading = !0);
              let e = C.x.getConnections(this.authConnector.chain).length > 0;
              await C.x.connectExternal(
                this.authConnector,
                this.authConnector.chain
              );
    ...
    >
      ...
      Copy link
        ...
        onCopyUri() {
          try {
            this.uri &&
              (g.w.copyToClopboard(this.uri), S.P.showSuccess("Link copied"));
          } catch {
      ...
      (M.styles = U),
        q([(0, r.wk)()], M.prototype, "socialProvider", void 0),
        q([(0, r.wk)()], M.prototype, "uri", void 0),
        q([(0, r.wk)()], M.prototype, "ready", void 0),
        q([(0, r.wk)()], M.prototype, "loading", void 0),
        q([(0, r.wk)()], M.prototype, "remoteFeatures", void 0),
        (M = q([(0, c.EM)("w3m-connecting-farcaster-view")], M));
    },
    54279: (e, t, o) => {
      o(15127);
    },
          ...
          class extends r.Kq {
            ...
            get lt() {
              return "function" == typeof this.G
                ? c.get(this.ht ?? globalThis)?.get(this.G)
                : this.G?.value;
            }
            disconnected() {
    ...
    `;
        ...
        templatePlacement() {
          return "center" === this.align
            ? (0,
              i.qy)` <wui-logo class="invisible" logo=${this.logo}></wui-logo>`
            : null;
        }
      };
      (d.styles = [s.W5, s.fD, c]),
        l([(0, r.MZ)()], d.prototype, "logo", void 0),
        l([(0, r.MZ)()], d.prototype, "name", void 0),
        l([(0, r.MZ)()], d.prototype, "align", void 0),
        l([(0, r.MZ)()], d.prototype, "tabIdx", void 0),
        l([(0, r.MZ)({ type: Boolean })], d.prototype, "disabled", void 0),
        (d = l([(0, n.E)("wui-list-social")], d));
    },
    89556: (e, t, o) => {
      var i = o(28312),
        r = o(745);
