...
`;
      ...
      let l = class extends i.WF {
        ...
        render() {
          ...
          let e =
            "md" === this.size || "xs" === this.size ? "mini-700" : "micro-700";
          return (0, i.qy)`
    ...
    `;
      ...
      (l.styles = [o.W5, n]),
        c([(0, r.MZ)()], l.prototype, "variant", void 0),
    ...
    14003: (e, t, a) => {
      a.r(t),
        a.d(t, {
          ...
          W3mRegisterAccountNameSuccess: () => _,
          W3mRegisterAccountNameView: () => O,
...
`;
      ...
      let g = class extends i.WF {
        ...
        render() {
          return (0,
          i.qy)`<div data-ready=${this.ready} id="w3m-frame-container"></div>`;
        }
        onShowIframe() {
        ...
        async syncTheme() {
          ...
          if (e) {
            let t = c.W.getSnapshot().themeMode,
              a = c.W.getSnapshot().themeVariables;
            await e.provider.syncTheme({
              themeVariables: a,
              w3mThemeVariables: (0, o.o)(a, t),
            });
          }
        }
      };
      (g.styles = u),
        ...
        (g = d([(0, l.EM)("w3m-approve-transaction-view")], g));
      var h = a(76610);
      a(50196), a(98160), a(22724);
        ...
        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
          ...
          for (var n = e.length - 1; n >= 0; n--)
            (r = e[n]) &&
              (s = (o < 3 ? r(s) : o > 3 ? r(t, a, s) : r(t, a)) || s);
        return o > 3 && s && Object.defineProperty(t, a, s), s;
      })([(0, l.EM)("w3m-upgrade-wallet-view")], p);
      var v = a(74236),
        w = a(60500),
        m = a(76631),
        f = a(11076),
...
`;
    ...
    `;
        ...
        baseNameTemplate() {
          return (0,
          i.qy)`<wui-text variant="paragraph-400" color="fg-200" class="base-name">
      ${w.o.WC_NAME_SUFFIX}
    </wui-text>`;
        }
        loadingTemplate() {
        ...
        errorTemplate() {
          return this.errorMessage
            ? (0,
              i.qy)`<wui-text variant="tiny-500" color="error-100" class="error"
      ...
      (A.styles = [R.W5, T]),
        j([(0, r.MZ)()], A.prototype, "errorMessage", void 0),
        j([(0, r.MZ)({ type: Boolean })], A.prototype, "disabled", void 0),
        j([(0, r.MZ)()], A.prototype, "value", void 0),
        j([(0, r.MZ)({ type: Boolean })], A.prototype, "loading", void 0),
        (A = j([(0, E.E)("wui-ens-input")], A)),
        a(21330),
        a(76197),
        a(72873),
        a(77509);
...
`;
          ...
          super(),
            ...
            this.usubscribe.push(
              ...
              f.U.subscribeKey("profileName", (e) => {
                (this.profileName = e),
                  e && (this.error = "You already own a name");
              })
            );
        }
        firstUpdated() {
    ...
    `;
        ...
        nameSuggestionTagTemplate() {
          return this.loading
            ? (0,
              i.qy)`<wui-loading-spinner size="lg" color="fg-100"></wui-loading-spinner>`
            : this.registered
            ? (0, i.qy)`<wui-tag variant="shade" size="lg">Registered</wui-tag>`
            : (0,
              i.qy)`<wui-tag variant="success" size="lg">Available</wui-tag>`;
        }
        templateSuggestions() {
          if (!this.name || this.name.length < 4 || this.error) return null;
          let e = this.registered
            ? this.suggestions.filter((e) => e.name !== this.name)
            : [];
          return (0,
    ...
    >
        ...
        async onSubmitName() {
          ...
          try {
            ...
            x.E.sendEvent({
              ...
              properties: {
                isSmartAccount:
                  (0, k.lj)(e) === M.Vl.ACCOUNT_TYPES.SMART_ACCOUNT,
                ensName: t,
              },
            }),
      ...
      (O.styles = z),
        N([(0, r.MZ)()], O.prototype, "errorMessage", void 0),
        N([(0, r.wk)()], O.prototype, "name", void 0),
        N([(0, r.wk)()], O.prototype, "error", void 0),
        N([(0, r.wk)()], O.prototype, "loading", void 0),
        N([(0, r.wk)()], O.prototype, "suggestions", void 0),
        N([(0, r.wk)()], O.prototype, "registered", void 0),
        N([(0, r.wk)()], O.prototype, "profileName", void 0),
        (O = N([(0, l.EM)("w3m-register-account-name-view")], O));
      var I = a(7273),
        C = a(19628);
      a(54279), a(36698), a(82786);
      let W = (0, i.AH)`
  .continue-button-container {
    width: 100%;
  }
`,
        _ = class extends i.WF {
          render() {
            return (0, i.qy)`
      <wui-flex
        flexDirection="column"
      ...
      >
        ...
        <wui-link
          @click=${() => {
            b.w.openHref(I.T.URLS.FAQ, "_blank");
          }}
        >
          Learn more
          ...
          if (
            ...
            for (var n = e.length - 1; n >= 0; n--)
              (r = e[n]) &&
                (s = (o < 3 ? r(s) : o > 3 ? r(t, a, s) : r(t, a)) || s);
          return o > 3 && s && Object.defineProperty(t, a, s), s;
        })([(0, l.EM)("w3m-register-account-name-success-view")], _));
    },
    21330: (e, t, a) => {
      a(23499);
    },
...
`;
      ...
      (l.styles = [o.W5, o.ck, n]),
        ...
        c([(0, r.MZ)()], l.prototype, "size", void 0),
        c([(0, r.MZ)()], l.prototype, "objectFit", void 0),
...
`;
    ...
    `;
      ...
      (u.styles = [o.W5, o.fD, c]),
        l([(0, r.MZ)()], u.prototype, "variant", void 0),
        l([(0, r.MZ)()], u.prototype, "imageSrc", void 0),
        l([(0, r.MZ)()], u.prototype, "imageIcon", void 0),
        l([(0, r.MZ)()], u.prototype, "imageIconSize", void 0),
        l([(0, r.MZ)({ type: Boolean })], u.prototype, "disabled", void 0),
        l([(0, r.MZ)()], u.prototype, "icon", void 0),
        l([(0, r.MZ)()], u.prototype, "href", void 0),
        l([(0, r.MZ)()], u.prototype, "text", void 0),
        (u = l([(0, n.E)("wui-chip")], u));
    },
    72873: (e, t, a) => {
      a(4537);
    },
...
`;
    ...
    `;
      ...
      (u.styles = [s.W5, s.fD, c]),
        ...
        l([(0, r.MZ)({ type: Boolean })], u.prototype, "disabled", void 0),
        l([(0, r.MZ)()], u.prototype, "color", void 0),
