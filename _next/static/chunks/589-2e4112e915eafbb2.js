  ...
  [589],
  {
    ...
    24975: (e, n, s) => {
      ...
      function d() {
        ...
        return (0, a.jsxs)("div", {
          className: "neo-dropdown neo-language-switcher",
          children: [
            (0, a.jsxs)("button", {
              className: "neo-switcher-btn btn btn-dark dropdown-toggle",
              type: "button",
              "data-bs-toggle": "dropdown",
              "aria-expanded": "false",
              children: [
                (0, a.jsx)(l.default, {
                  src: "/images/flags-svg/".concat(i, ".svg"),
                  width: 20,
                  height: 20,
                  alt: s,
                  className: "neo-lang-flag rounded-circle",
                }),
                s.toUpperCase(),
              ],
            }),
            (0, a.jsx)("div", {
              ...
              children: (0, a.jsx)("ul", {
                className: "neo-lang-list list-unstyled mb-0",
                children: o.map((e) =>
                  (0, a.jsx)(
                    "li",
                    {
                      children: (0, a.jsxs)(r(), {
                        href: "/".concat(
                          e.short +
                            n
                              .split("/")
                              .filter((e) => !o.map((e) => e.short).includes(e))
                              .join("/")
                        ),
                        className:
                          "dropdown-item d-flex align-items-center gap-2 "
                            .concat(s === e.short ? "active" : "", " ")
                            .concat(e.disabled ? "disabled" : ""),
                        children: [
                          (0, a.jsx)(l.default, {
                            src: "/images/flags-svg/".concat(e.code, ".svg"),
                            width: 20,
                            height: 20,
                            alt: e.name,
                            className: "neo-lang-flag rounded-circle",
                          ...
                          (0, a.jsxs)("span", {
                            children: [e.name, e.disabled && " (Soon)"],
                          }),
                        ],
                      }),
                    },
