...
`;
      ...
      (u.styles = [n.W5, n.ck, i]),
        c([(0, r.MZ)()], u.prototype, "src", void 0),
        c([(0, r.MZ)()], u.prototype, "alt", void 0),
        c([(0, r.MZ)()], u.prototype, "size", void 0),
        c([(0, r.MZ)()], u.prototype, "objectFit", void 0),
        (u = c([(0, s.E)("wui-image")], u));
    },
    35331: (e, t, o) => {
      o.d(t, { GN: () => N });
      var a = o(43217),
      ...
      let k = {
        ...
        getGasPriceInUSD(e, t, o) {
          let a = k.getGasPriceInEther(t, o);
        ...
        getToTokenAmount({
          ...
          let c = n.S.bigNumber(r).times(0.0085),
            u = n.S.bigNumber(r).minus(c).times(n.S.bigNumber(10).pow(s)),
            l = n.S.bigNumber(o).div(a),
            d = s - i;
          return u
            .times(l)
      ...
      let f = {
          ...
          networkTokenSymbol: "",
          inputError: void 0,
          slippage: l.oU.CONVERT_SLIPPAGE_TOLERANCE,
          tokens: void 0,
        ...
        I = {
          ...
          subscribeKey: (e, t) => (0, r.u$)(y, e, t),
          getParams() {
            let e = h.W.state.activeCaipAddress,
              t = h.W.state.activeChain,
              o = d.w.getPlainAddress(e),
              a = (0, u.K1)(),
              r = b.a.getConnectorId(t);
            ...
            let i = !y.toToken?.address || !y.toToken?.decimals,
              c =
                ...
                !n.S.bigNumber(y.sourceTokenAmount).gt(0),
              l = !y.sourceTokenAmount;
            return {
              networkAddress: a,
              fromAddress: o,
              fromCaipAddress: e,
          ...
          setSourceToken(e) {
            ...
            (y.sourceToken = e), N.setTokenPrice(e.address, "sourceToken");
          },
          ...
          setToToken(e) {
            ...
            (y.toToken = e), N.setTokenPrice(e.address, "toToken");
          },
          setToTokenAmount(e) {
            y.toTokenAmount = e ? n.S.formatNumberToLocalString(e, 6) : "";
          },
          async setTokenPrice(e, t) {
            let o = y.tokensPriceMap[e] || 0;
            o || ((y.loadingPrices = !0), (o = await N.getAddressPrice(e))),
              "sourceToken" === t
                ? (y.sourceTokenPriceInUSD = o)
                : "toToken" === t && (y.toTokenPriceInUSD = o),
              y.loadingPrices && (y.loadingPrices = !1),
              N.getParams().availableToSwap && N.swapTokens();
          },
          switchTokens() {
            if (y.initializing || !y.initialized) return;
            let e = y.toToken ? { ...y.toToken } : void 0,
              t = y.sourceToken ? { ...y.sourceToken } : void 0,
              o = e && "" === y.toTokenAmount ? "1" : y.toTokenAmount;
            N.setSourceToken(e),
              N.setToToken(t),
              N.setSourceTokenAmount(o),
              N.setToTokenAmount(""),
              N.swapTokens();
          },
          resetState() {
            (y.myTokensWithBalance = f.myTokensWithBalance),
              (y.tokensPriceMap = f.tokensPriceMap),
              (y.initialized = f.initialized),
              (y.sourceToken = f.sourceToken),
              (y.sourceTokenAmount = f.sourceTokenAmount),
              (y.sourceTokenPriceInUSD = f.sourceTokenPriceInUSD),
              (y.toToken = f.toToken),
              (y.toTokenAmount = f.toTokenAmount),
              (y.toTokenPriceInUSD = f.toTokenPriceInUSD),
              (y.networkPrice = f.networkPrice),
              (y.networkTokenSymbol = f.networkTokenSymbol),
              (y.networkBalanceInUSD = f.networkBalanceInUSD),
              (y.inputError = f.inputError),
              (y.myTokensWithBalance = f.myTokensWithBalance);
          },
          resetValues() {
            let { networkAddress: e } = N.getParams(),
              t = y.tokens?.find((t) => t.address === e);
            N.setSourceToken(t), N.setToToken(void 0);
          },
          ...
          async initializeState() {
            if (!y.initializing) {
              if (((y.initializing = !0), !y.initialized))
                try {
                  await N.fetchTokens(), (y.initialized = !0);
                } catch (e) {
                  (y.initialized = !1),
          ...
          async fetchTokens() {
            ...
            await N.getTokenList(),
              await N.getNetworkTokenPrice(),
              await N.getMyTokensWithBalance();
            let t = y.tokens?.find((t) => t.address === e);
            t &&
              ((y.networkTokenSymbol = t.symbol),
              N.setSourceToken(t),
              N.setSourceTokenAmount("1"));
          },
          async getTokenList() {
            let e = await T.s.getTokenList();
            (y.tokens = e),
              (y.popularTokens = e.sort((e, t) =>
                e.symbol < t.symbol ? -1 : +(e.symbol > t.symbol)
              )),
              (y.suggestedTokens = e.filter(
                (e) => !!l.oU.SWAP_SUGGESTED_TOKENS.includes(e.symbol),
                {}
              ));
          },
          async getAddressPrice(e) {
            let t = y.tokensPriceMap[e];
            if (t) return t;
            let o = await w.T.fetchTokenPrice({ addresses: [e] }),
              a = o?.fungibles || [],
              r = [...(y.tokens || []), ...(y.myTokensWithBalance || [])],
          ...
          async getNetworkTokenPrice() {
            let { networkAddress: e } = N.getParams(),
              t = await w.T.fetchTokenPrice({ addresses: [e] }).catch(
                () => (
          ...
          async getMyTokensWithBalance(e) {
            let t = await c.Z.getMyTokensWithBalance(e),
              o = T.s.mapBalancesToSwapTokens(t);
            o && (await N.getInitialGasPrice(), N.setBalances(o));
          },
          setBalances(e) {
            let { networkAddress: t } = N.getParams(),
              o = h.W.state.activeCaipNetwork;
            if (!o) return;
          ...
          async getInitialGasPrice() {
            let e = await T.s.fetchGasPrice();
            if (!e) return { gasPrice: null, gasPriceInUSD: null };
            if (h.W.state?.activeCaipNetwork?.chainNamespace === "solana")
              return (
                (y.gasFee = e.standard ?? "0"),
                (y.gasPriceInUSD = n.S.multiply(e.standard, y.networkPrice)
                  .div(1e9)
                  .toNumber()),
                {
              ...
              );
            {
              let t = e.standard ?? "0",
                o = BigInt(t),
                a = BigInt(15e4),
                r = k.getGasPriceInUSD(y.networkPrice, a, o);
              return (
                (y.gasFee = t),
                (y.gasPriceInUSD = r),
          ...
          async swapTokens() {
            let e = m.U.state.address,
              t = y.sourceToken,
              o = y.toToken,
              a = n.S.bigNumber(y.sourceTokenAmount).gt(0);
            if (
              (a || N.setToTokenAmount(""), !o || !t || y.loadingPrices || !a)
            )
              return;
            y.loadingQuote = !0;
            let r = n.S.bigNumber(y.sourceTokenAmount)
              .times(10 ** t.decimals)
              .round(0);
            try {
              let a = await w.T.fetchSwapQuote({
                userAddress: e,
                from: t.address,
                to: o.address,
                gasPrice: y.gasFee,
              ...
              let i = n.S.bigNumber(s)
                .div(10 ** o.decimals)
                .toString();
              N.setToTokenAmount(i),
                N.hasInsufficientToken(y.sourceTokenAmount, t.address)
                  ? (y.inputError = "Insufficient balance")
                  : ((y.inputError = void 0), N.setTransactionDetails());
            } catch (e) {
              (y.loadingQuote = !1), (y.inputError = "Insufficient balance");
            }
          },
          async getTransaction() {
            let { fromCaipAddress: e, availableToSwap: t } = N.getParams(),
              o = y.sourceToken,
              a = y.toToken;
            if (e && t && o && a && !y.loadingQuote)
              try {
                let t;
                return (
                  (y.loadingBuildTransaction = !0),
                  (t = (await T.s.fetchSwapAllowance({
                    userAddress: e,
                    tokenAddress: o.address,
                    sourceTokenAmount: y.sourceTokenAmount,
                    sourceTokenDecimals: o.decimals,
                  }))
                    ? await N.createSwapTransaction()
                    : await N.createAllowanceTransaction()),
          ...
          async createAllowanceTransaction() {
            ...
            if (e && o) {
              ...
              try {
                let a = await w.T.generateApproveCalldata({
                    from: t,
                    to: o,
                    userAddress: e,
                  }),
                  r = {
                    data: a.tx.data,
                    to: d.w.getPlainAddress(a.tx.from),
          ...
          async createSwapTransaction() {
            let {
              ...
              r = y.toToken;
            if (!t || !o || !a || !r) return;
            let n = S.x.parseUnits(o, a.decimals)?.toString();
            try {
              let o = await w.T.generateSwapCalldata({
                  userAddress: t,
                  from: a.address,
                  to: r.address,
                  amount: n,
                ...
                u = {
                  data: o.tx.data,
                  to: d.w.getPlainAddress(o.tx.to),
                  gas: i,
                  gasPrice: c,
          ...
          async sendTransactionForApproval(e) {
            let { fromAddress: t, isAuthConnector: o } = N.getParams();
            ...
            try {
              await S.x.sendTransaction({
                ...
                await N.swapTokens(),
                await N.getTransaction(),
                (y.approvalTransaction = void 0),
                (y.loadingApprovalTransaction = !1);
            } catch (e) {
              (y.transactionError = e?.shortMessage),
                (y.loadingApprovalTransaction = !1),
                ...
                P.E.sendEvent({
                  ...
                  properties: {
                    ...
                    swapFromToken: N.state.sourceToken?.symbol || "",
                    swapToToken: N.state.toToken?.symbol || "",
                    swapFromAmount: N.state.sourceTokenAmount || "",
                    swapToAmount: N.state.toTokenAmount || "",
                    isSmartAccount:
                      (0, u.lj)("eip155") === i.Vl.ACCOUNT_TYPES.SMART_ACCOUNT,
                  },
                });
            }
          },
          async sendTransactionForSwap(e) {
            ...
            let r = `Swapping ${
              ...
              } to ${n.S.formatNumberToLocalString(o, 3)} ${y.toToken?.symbol}`,
              s = `Swapped ${
                y.sourceToken?.symbol
              } to ${n.S.formatNumberToLocalString(o, 3)} ${y.toToken?.symbol}`;
            a
              ? v.I.pushTransactionStack({
                  onSuccess() {
                    v.I.replace("Account"), A.P.showLoading(r), I.resetState();
                  },
                })
              : A.P.showLoading("Confirm transaction in your wallet");
            try {
              let o = [y.sourceToken?.address, y.toToken?.address].join(","),
                r = await S.x.sendTransaction({
                  address: t,
                  to: e.to,
                  data: e.data,
                  value: e.value,
          ...
          hasInsufficientToken: (e, t) =>
            k.isInsufficientSourceTokenForSwap(e, t, y.myTokensWithBalance),
          setTransactionDetails() {
            let { toTokenAddress: e, toTokenDecimals: t } = N.getParams();
            e &&
              t &&
